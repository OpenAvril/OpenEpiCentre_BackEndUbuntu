...
#include "Output_praise3.h"
double* CLIBOpenEpiCentre::Output_praise3::_REG_ptr_output_praise3_Value = NULL;
// public.
...
void CLIBOpenEpiCentre::Output_praise3::stat_CLASS_boot0_DECLAIRE_Output_praise3()
{
	std::cout << "entered stat_CLASS_boot0_DECLAIRE_Output_praise3()" << std::endl;

	std::cout << "exiting stat_CLASS_boot0_DECLAIRE_Output_praise3()" << std::endl;
}
...
void CLIBOpenEpiCentre::Output_praise3::stat_REG_boot0_DECLAIRE_Output_praise3()
{
	std::cout << "entered stat_REG_boot0_DECLAIRE_Output_praise3()" << std::endl;

	std::cout << "exiting stat_REG_boot0_DECLAIRE_Output_praise3()" << std::endl;
}
// private.
void CLIBOpenEpiCentre::Output_praise3::stat_REG_boot1_DEFINE_output_Value()
{
	_REG_ptr_output_praise3_Value = NULL;
}
...
{
	*_REG_ptr_output_praise3_Value = (double)(0.0);
}
