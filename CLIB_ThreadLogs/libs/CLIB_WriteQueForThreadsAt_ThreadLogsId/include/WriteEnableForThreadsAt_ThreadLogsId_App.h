...
namespace CLIBWriteQueAtThreadLogsId {
    ...
    public:
        WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId);
        ...
        class WriteEnableForThreadsAt_ThreadLogsId_Control* dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(uint8_t threadId);
        ...
        void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId, WriteEnableForThreadsAt_ThreadLogsId_Framework* obj);
    ...
    private:
        static class WriteEnableForThreadsAt_ThreadLogsId_Control* _stat_CLASS_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control;
        ...
        static class WriteEnableForThreadsAt_ThreadLogsId_Control* stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(uint8_t threadId);
    };
}
#endif
