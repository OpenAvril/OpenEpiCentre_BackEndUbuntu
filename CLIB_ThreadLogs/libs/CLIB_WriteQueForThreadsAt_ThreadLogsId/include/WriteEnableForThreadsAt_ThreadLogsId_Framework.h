...
namespace CLIBWriteQueAtThreadLogsId {
    ...
    public:
        ...
        WriteEnableForThreadsAt_ThreadLogsId_App* dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId);
        WriteEnableForThreadsAt_ThreadLogsId_Global* dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId);
    ...
    private:
        static WriteEnableForThreadsAt_ThreadLogsId_App* _stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_App;
        static WriteEnableForThreadsAt_ThreadLogsId_Global* _stat_CLASS_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_Global;
        ...
        static WriteEnableForThreadsAt_ThreadLogsId_App* stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId);
        static WriteEnableForThreadsAt_ThreadLogsId_Global* stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId);
    };
}
#endif