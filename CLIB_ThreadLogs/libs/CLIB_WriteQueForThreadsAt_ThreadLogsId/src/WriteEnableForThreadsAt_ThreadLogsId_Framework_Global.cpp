...
// public.
    CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
    }
    CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::~WriteEnableForThreadsAt_ThreadLogsId_Framework_Global() {
        std::cout << "thread "  << 0 << " :: thread ?" << " :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Framework : WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
        ...
        std::cout << "thread "  << 0 << " :: thread ?" << " :: exiting LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Framework : WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
    }
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
    }
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= CONST : dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= CONST : dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= CONST : dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= uint8_t : dyn_REG_get_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= int : stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Bool_To_Int(threadId)." << std::endl;
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msbdouble_To_MsbByteArray(uint8_t threadId, double value) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= unsigned char* : stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msbdouble_To_MsbByteArray(threadId)." << std::endl;
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(uint8_t threadId, uint8_t value) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= unsigned char* : stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= unsigned char* : stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbBoolean_To_MsbByteArray(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbBoolean(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= double : stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbDouble(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= uint8_t : stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_Msbuint8_t(threadId)." << std::endl;
...
// private.
    int CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Bool_To_Int(uint8_t threadId, bool value) {
        ...
        *temp = 2;
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= int : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Bool_To_Int(threadId)." << std::endl;
        return *temp;
    }
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbBoolean_To_MsbByteArray(uint8_t threadId, bool value) {
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= unsigned char* : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbBoolean_To_MsbByteArray(threadId)." << std::endl;
        return buffer;
    }
    bool CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbBoolean(uint8_t threadId, const unsigned char* byteArray) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbBoolean(threadId)." << std::endl;
    ...
    double CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbDouble(uint8_t threadId, const unsigned char* byteArray) {
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= double : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbDouble(threadId)." << std::endl;
        return temp;
    }
    double CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_Msbdouble(uint8_t threadId, const unsigned char* byteArray) {
        double temp;
    ...
    uint8_t CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_Msbuint8_t(uint8_t threadId, const unsigned char* byteArray) {
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= uint8_t : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_Msbuint8_t(threadId)." << std::endl;
        return temp;
    }
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msbdouble_To_MsbByteArray(uint8_t threadId, double value) {
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= unsigned char* : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msbdouble_To_MsbByteArray(threadId)." << std::endl;
        return buffer;
    }
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbDouble_To_MsbByteArray(uint8_t threadId, double value) {
        unsigned char* buffer = nullptr;
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(uint8_t threadId, uint8_t value) {
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= unsigned char* : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(threadId)." << std::endl;
        return buffer;
    }
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_Global::stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(threadId)." << std::endl;
        *_stat_REG_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE = {true, true};
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(threadId)." << std::endl;
    }
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Global : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= std::array<bool,2>* : stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= std::array<bool,2>* : stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= std::array<bool,2>* : stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= uint8_t* : stat_REG_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(threadId)." << std::endl;
