...
// public.
    CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId)
    {
    ...
    std::array<bool,2> CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(uint8_t threadId)
    {
    ...
    std::array<bool,2> CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(uint8_t threadId)
    {
    ...
    uint8_t CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::dyn_REG_get_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(uint8_t threadId)
    {
    ...
    int CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Bool_To_Int(uint8_t threadId, bool value)
    {
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msbdouble_To_MsbByteArray(uint8_t threadId, double value) {
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(uint8_t threadId, uint8_t value) {
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbBoolean_To_MsbByteArray(uint8_t threadId, bool value)
    {
    ...
    bool CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbBoolean(uint8_t threadId, const unsigned char* byteArray)
    {
    ...
    double CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbDouble(uint8_t threadId, const unsigned char* byteArray)
    {
    ...
    uint8_t CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_Msbuint8_t(uint8_t threadId, const unsigned char* byteArray)
    {
...
// private.
    int CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Bool_To_Int(uint8_t threadId, bool value) {
        int* temp = nullptr;
        *temp = 2;
        if (value) {
            *temp = 1;;
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbBoolean_To_MsbByteArray(uint8_t threadId, bool value) {
    ...
    bool CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbBoolean(uint8_t threadId, const unsigned char* byteArray) {
    ...
    double CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_MsbDouble(uint8_t threadId, const unsigned char* byteArray) {
        double temp;
    ...
    uint8_t CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_Msbuint8_t(uint8_t threadId, const unsigned char* byteArray) {
        uint8_t temp;
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msbdouble_To_MsbByteArray(uint8_t threadId, double value) {
        unsigned char* buffer = nullptr;
    ...
    unsigned char* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(uint8_t threadId, uint8_t value) {
        unsigned char* buffer = nullptr;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(uint8_t threadId)
    {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(uint8_t threadId)
    {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(uint8_t threadId)
    {
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(uint8_t threadId)
    {
    ...
    std::array<bool,2>* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE(uint8_t threadId)
    {
    ...
    std::array<bool,2>* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WAIT(uint8_t threadId)
    {
    ...
    std::array<bool,2>* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_WRITE(uint8_t threadId)
    {
    ...
    uint8_t* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_REG_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(uint8_t threadId)
    {
