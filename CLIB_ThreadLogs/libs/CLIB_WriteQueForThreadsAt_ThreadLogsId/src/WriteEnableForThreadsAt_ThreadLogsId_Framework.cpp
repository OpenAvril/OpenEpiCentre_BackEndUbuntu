...
#include <iostream>
	CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_App* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::_stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_App;
	CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::_stat_CLASS_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_Global;
// public.
	...
	CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_App* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId) {
	...
	CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId) {
...
// private.
	...
	void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::stat_CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId)	{
		...
		_stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_App = new class CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_App();
	...
	void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::pr_stat_CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId) {
		...
		_stat_CLASS_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_Global = new class CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global();
		while (stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Global(threadId) == nullptr) {}
		std::cout << "thread "  << threadId << " :: thread ?" << " :: entered LIB :: CLIBWriteQueAtThreadLogsId : WriteEnableForThreadsAt_ThreadLogsId_Framework : pr_stat_CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ThreadLogsId_Global(threadId)." << std::endl;
	}
	CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_App* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId) {
	...
	CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global* CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework::stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId) {
