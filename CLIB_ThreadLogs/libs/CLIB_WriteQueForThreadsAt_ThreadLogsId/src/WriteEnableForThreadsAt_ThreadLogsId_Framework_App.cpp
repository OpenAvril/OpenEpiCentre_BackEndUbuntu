...
#include <ostream>
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_App::dyn_APP_FUNCT_write_End(uint8_t threadId, WriteEnableForThreadsAt_ThreadLogsId_Framework* obj, uint8_t coreId) {
        ...
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_isWriteEndThreadRELASE_ONE(true);
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteEndThreadId_Index(obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteEndThreadId_Index(threadId)+1);
        if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteEndThreadId_Index(threadId) == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control(threadId)->dyn_REG_get_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(threadId)) {
            obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteEndThreadId_Index(0);
        }
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_2ibt_FLAG_WriteState(coreId, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control(threadId)->dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ThreadLogsId_2bitFLAG_IDLE( << std::endl;
    ...
    void CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Framework_App::dyn_APP_FUNCT_write_Start(uint8_t threadId, WriteEnableForThreadsAt_ThreadLogsId_Framework* obj, uint8_t coreId)
    {
        ...
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_isWriteStartThreadRELASE_ONE(true);
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteStartThreadId_Index(obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteStartThreadId_Index(threadId)+1);
        if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteStartThreadId_Index(threadId) == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control(threadId)->dyn_REG_get_WriteEnableForThreadsAt_ThreadLogsId_number_Of_Implemented_Threads(threadId)) {
            obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeCycle_Try_WriteStartThreadId_Index(0);
        }
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_APP_FUNCT_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeQue_Update(obj);
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_APP_FUNCT_WriteEnableForThreadsAt_ThreadLogsId_Framework_App_Control_writeEnable_SortQue(obj);
