...
// public.
	void* CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_generate_Program(uint8_t threadId)	{
		...
		CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ThreadLogsId_Control(CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework( << std::endl;
		std::cout << "thread "  << threadId << " :: done Registers - DEFINE." << std::endl;
		std::cout << "thread "  << threadId << " :: started Registers - SUBSTANTIATE." << std::endl;
		CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ThreadLogsId_Control(CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework( << std::endl;
		...
		CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ThreadLogsId_Control(CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework( << std::endl;
	...
	unsigned char* CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(uint8_t threadId)	{
		...
		*result = true;
		...
		return WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbBoolean_To_MsbByteArray(*result);
	}
	...
	void CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_write_End(uint8_t threadId, unsigned char* bytes)	{
		...
		if (!CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_REG_get_CLIBLaunchQueAtThreadLogsId_isFLAGINSTANTIATED(threadId)->at(0)) {
			CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_APP_FUNCT_write_End(CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(threadId), WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_MsbByteArray_To_Msbuint8_t(bytes << std::endl;
			CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Control_isWriteEndThreadRELASE_REMAINING(true);
		}
		else {
	...
	void CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_write_Start(uint8_t threadId, unsigned char* bytes) {
		...
		if (!CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_REG_get_CLIBLaunchQueAtThreadLogsId_isFLAGINSTANTIATED(threadId)->at(0)) {
			...
			CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App_Control(threadId)->dyn_REG_set_FLAG_WriteEnableForThreadsAt_ThreadLogsId_Control_isWriteStartThreadRELASE_REMAINING(true);
		}
		else {
