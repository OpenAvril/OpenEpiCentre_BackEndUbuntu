...
namespace CLIB_ThreadLogs {
    ...
    public:
        ...
        void dyn_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(uint8_t threadId, std::list<std::string>* message);
        void dyn_APP_FUNCT_CLIB_ThreadLogs_printLog(uint8_t threadId, std::list<std::string>* message);
    ...
    private:
        void stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(uint8_t threadId, std::list<std::string>* message);
        void stat_APP_FUNCT_CLIB_ThreadLogs_printLog(uint8_t threadId, std::list<std::string>* message);
    };
}
#endif