...
// public.
	void* CLIB_ThreadLogs::CLIB_ThreadLogs::stat_App_FUNCT_CLIB_ThreadLogs_generate_Program(uint8_t threadId) {
		void* result = nullptr;
		CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_write_Start(CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(threadId << std::endl;
		...
		stat_CLASS_get_ptr_CLIB_ThreadLogs_Framework(threadId)->dyn_CLASS_get_ptr_CLIB_ThreadLogs_Framework_App()->dyn_CLASS_ptr_CLIB_ThreadLogs_Framework_App_Execute()->
		...
		result = static_cast<void*>(stat_CLASS_get_ptr_CLIB_ThreadLogs_Framework(threadId << std::endl;
		CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_write_End(CLIBWriteQueAtThreadLogsId::WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(threadId << std::endl;
		return result;
	}
	unsigned char* CLIB_ThreadLogs::CLIB_ThreadLogs::stat_App_FUNCT_CLIB_ThreadLogs_get_flag_isPGM_INSTANTIATED(uint8_t threadId) {
		...
		*resultA = true;
		...
		result = CLIB_ThreadLogs_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_STACK_MsbBoolean_To_MsbByteArray(threadId, *resultA);
...
// private.
	void CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_Calc_IsAllINSTANTIATED(uint8_t threadId) {
		...
		for (uint8_t memberFunctionId = 1; memberFunctionId < static_cast<uint8_t>(stat_REG_get_CLIB_ThreadLogs_array_Of_flag_isINSTANTIATED(threadId)->size( << std::endl; memberFunctionId++) {
	...
	void CLIB_ThreadLogs::CLIB_ThreadLogs::stat_REG_boot2_SUBSTANTIATE_CLIB_ThreadLogs_array_Of_flag_isINSTANTIATED(uint8_t threadId) {
		...
		for (uint8_t index = 0; index < static_cast<uint8_t>(stat_REG_get_CLIB_ThreadLogs_array_Of_flag_isINSTANTIATED(threadId)->size( << std::endl; index++)	{
