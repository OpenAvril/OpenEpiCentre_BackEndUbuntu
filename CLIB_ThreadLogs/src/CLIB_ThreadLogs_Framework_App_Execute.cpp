...
#include <iostream>
    void* CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::_stat_PGM_CLIB_WriteQueForThreadsAt_ThreadLogsId;
// public.
    CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::CLIB_ThreadLogs_Framework_App_Execute(uint8_t threadId) {
    ...
    CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::~CLIB_ThreadLogs_Framework_App_Execute() {
        delete _stat_PGM_CLIB_WriteQueForThreadsAt_ThreadLogsId;
    }
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::dyn_REG_boot1_DEFINE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::dyn_REG_boot2_SUBSTANTIATE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::dyn_REG_boot3_INITIALISE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::dyn_PGM_boot4_INSTANTIATE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
        stat_PGM_boot4_INSTANTIATE_CLIB_ThreadLogs_Framework_Execute(threadId);
    }
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_CLASS_boot0_DECLARE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_CLASS_boot1_DEFINE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_CLASS_boot3_INITIALISE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_REG_boot0_DECLARE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
...
// private.
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_PGM_boot1_DEFINE_WriteQueForThreadsAt_WriteQue_ThreadLogsId(uint8_t threadId) {
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_PGM_boot3_INITIALISE_WriteQueForThreadsAt_WriteQue_ThreadLogsId(uint8_t threadId) {
        ...
        _stat_PGM_CLIB_WriteQueForThreadsAt_ThreadLogsId = CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_generate_Program();
    ...
    void CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_PGM_boot4_INSTANTIATE_CLIB_ThreadLogs_Framework_Execute(uint8_t threadId) {
        ...
        unsigned char* bytes_DEFAULT = WriteEnableForThreadsAt_ThreadLogsId_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ThreadLogsId_Msb_uint8_t_to_MsbByteArray(255);
        ...
        unsigned char* tempA1 =  CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_get_FLAG_isPGM_INSTANTIATED();
        CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_terminate_Program();
        CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_write_End(bytes_DEFAULT);
        CLIBWriteQueAtThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId::CLIB_WriteEnableForThreadsAt_ThreadLogsId_App_FUNCT_write_Start(bytes_DEFAULT);
    ...
    void* CLIBWriteQueAtThreadLogsId::CLIB_ThreadLogs_Framework_App_Execute::stat_PGM_get_ptr_WriteQueForThreadsAt_WriteQue_ThreadLogsId(uint8_t threadId) {
