...
void* CLIBOpenEpiCentre::ConcurrentServerIO::dyn_PGM_get_program_WriteEnableStack_ServerInputAction()
{
...
void* CLIBOpenEpiCentre::ConcurrentServerIO::dyn_PGM_get_program_WriteEnableStack_ServerOutputRecieve()
{
	if (stat_REG_get_ptr_flag_isMemberFunctionINSTANTIATED()[8] == false) {
		return stat_CLASS_get_ptr_Framework_Server()->dyn_CLASS_get_ptr_Server()->dyn_CLASS_get_ptr_Execute()->dyn_PGM_get_WriteEnable_ServerOutputRecieve();
	}
	else {
...
unsigned char* CLIBOpenEpiCentre::ConcurrentServerIO::dyn_REG_get_flag_isStackLoaded_Server_InputAction()
{
