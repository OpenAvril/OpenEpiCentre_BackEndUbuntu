...
// public.
    ...
    void CLIBOpenEpiCentre::Server::stat_CLASS_boot0_DECLAIRE_Server()
    {
    ...
    void CLIBOpenEpiCentre::Server::stat_REG_boot0_DECLAIRE_Server()
    {
...
// private.
    ...
    void CLIBOpenEpiCentre::Server::stat_CLASSS_boot3_INITIALISE_Global()
    {
