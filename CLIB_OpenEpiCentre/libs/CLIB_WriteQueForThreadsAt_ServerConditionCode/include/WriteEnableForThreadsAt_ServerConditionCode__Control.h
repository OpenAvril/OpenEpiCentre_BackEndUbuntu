#ifndef CLIBWriteEnableForThreadsAtServerConditionCode_WRITEENABLEFORTHREADSAT_ServerConditionCode__Control_H
#define CLIBWriteEnableForThreadsAtServerConditionCode_WRITEENABLEFORTHREADSAT_ServerConditionCode__Control_H
#include <cstdint>
#include <list>
namespace CLIBWriteQueAtServerConditionCode
{
    ...
    public:
        ...
        unsigned long long dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerConditionCode__Control__list_Of_WriteActive_Count_For_ThreadId(uint8_t concurrentThreadID);
        unsigned long long dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerConditionCode__Control__list_Of_WriteIdle_Count_For_ThreadId(uint8_t concurrentThreadID);
        unsigned long long dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerConditionCode__Control__list_Of_WriteWait_Count_For_ThreadId(uint8_t concurrentThreadID);
        ...
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteActive_Count_For_ThreadId(uint8_t concurrentThreadID, unsigned long long newCount);
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteIdle_Count_For_ThreadId(uint8_t concurrentThreadID, unsigned long long newCount);
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteWait_Count_For_ThreadId(uint8_t concurrentThreadID, unsigned long long newCount);
    ...
    private:
        ...
        static std::list<unsigned long long>* _stat_REG_LIST_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteACTIVE_Count_For_ThreadId;
        static std::list<unsigned long long>* _stat_REG_LIST_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteIDLE_Count_For_ThreadId;
        static std::list<unsigned long long>* _stat_REG_LIST_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteWAIT_Count_For_ThreadId;
        ...
        static std::list<unsigned long long>* stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteActive_Count_For_ThreadId();
        static std::list<unsigned long long>* stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteIdle_Count_For_ThreadId();
        static std::list<unsigned long long>* stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteWait_Count_For_ThreadId();
        ...
        static void stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteACTIVE_Count_For_ThreadId(uint8_t concurrentThreadID, unsigned long long newCount);
        static void stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteIdle_Count_For_ThreadId(uint8_t concurrentThreadID, unsigned long long newCount);
        static void stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerConditionCode__Control__WriteWait_Count_For_ThreadId(uint8_t concurrentThreadID, unsigned long long newCount);
