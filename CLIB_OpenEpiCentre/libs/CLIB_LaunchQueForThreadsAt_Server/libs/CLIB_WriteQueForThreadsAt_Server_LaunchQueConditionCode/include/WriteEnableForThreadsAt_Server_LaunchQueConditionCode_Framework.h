...
namespace CLIBWriteQueAtThreadLogsId {
    ...
    public:
        WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework(uint8_t threadId);
        ...
        WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework_App* dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId);
        WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework_Global* dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId);
    ...
    private:
        static WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework_App* _stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_App;
        static WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework_Global* _stat_CLASS_ptr_WriteEnableForThreadsAt_ThreadLogsId_Framework_Global;
        ...
        static WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework_App* stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_App(uint8_t threadId);
        static WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework_Global* stat_CLASS_get_ptr_WriteEnableForThreadsAt_ThreadLogsId_Global(uint8_t threadId);
    };
}
#endif