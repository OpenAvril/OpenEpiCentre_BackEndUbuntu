...
extern "C" {
    namespace CLIBLaunchQueAtServer {
        ...
        private:
            ...
            static class WriteEnableForThreadsAt_Server_LaunchQueConditionCode_Framework* CLIB_WriteEnableForThreadsAt_ThreadLogsId_stat_CLASS_get_ptr_Framework(uint8_t threadId);
