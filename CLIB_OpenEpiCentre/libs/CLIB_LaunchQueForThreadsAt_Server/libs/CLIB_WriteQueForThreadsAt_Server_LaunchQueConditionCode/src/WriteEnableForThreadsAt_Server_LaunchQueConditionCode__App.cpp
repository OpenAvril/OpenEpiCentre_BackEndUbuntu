...
#include <ostream>
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::dyn_APP_FUNCT_write_Server(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj, uint8_t coreId)
    {
