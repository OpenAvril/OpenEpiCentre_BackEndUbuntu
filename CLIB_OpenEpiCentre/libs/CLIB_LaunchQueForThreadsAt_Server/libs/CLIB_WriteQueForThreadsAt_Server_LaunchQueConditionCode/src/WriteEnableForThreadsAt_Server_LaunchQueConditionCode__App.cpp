...
#include <iostream>
#include <ostream>
    CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control* CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::_stat_CLASS_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control;
    CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::CLASS_boot0_DECLARE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::CLASS_boot1_DEFINE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::REG_boot0_DECLARE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::REG_boot1_DEFINE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj)
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj)
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::REG_boot3_INITIALISE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj)
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::dyn_APP_FUNCT_write_End(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj, uint8_t coreId)
    {
        while (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE()) {
            ...
            obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE(false);
        }
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE(true);
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index(obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index()+1);
        if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index() == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Global()->dyn_REG_get_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__number_Of_Implemented_Threads()) {
            obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index(0);
        }
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::dyn_APP_FUNCT_write_Start(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj, uint8_t coreId)
    {
    ...
    CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control* CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()
    {
        return stat_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control();
    }

    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()
    {
        _stat_CLASS_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control = nullptr;
    }

    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::stat_CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()
    {
        _stat_CLASS_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control = new class CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control();
        while (stat_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control() == nullptr) {}
    }
    CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control* CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App::stat_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()
    {
