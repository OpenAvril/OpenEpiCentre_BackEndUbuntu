...
#include <iostream>
#include <iterator>
    bool* CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__isWriteStartThreadRELASE_ONE;
    bool* CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__isWriteStartThreadRELASE_REMAINING;
...
// public.
    CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control() {
    ...
    CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::~WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control() {
            ...
            delete _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_ONE;
            delete _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_REMAINING;
            ...
            delete _stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index;
        }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__dynamicIn(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj, uint8_t coreId) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__dynamicOut(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj, uint8_t coreId) {
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index(false);
        if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index() == coreId) {

        }
        else {
            while (!obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App()->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__App__Control()->dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING()) {

            }
        }
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeEnable_Activate(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj, uint8_t coreId) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeEnable_SortQue(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeQue_Update(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj) {
        ...
        stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE();
        stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING();
        ...
        stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index();
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj) {
        ...
        stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE();
        stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING();
        ...
        stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index();
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control(WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj) {
        ...
        stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE();
        stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING();
        ...
        stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index();
    ...
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE() {
        return stat_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE();
    }
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_REMAINING() {
    ...
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE() {
        return stat_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE();
    }
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING() {
        return stat_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING();
    }
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index() {
    ...
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index() {
        return stat_REG_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index();
    }
    std::array<bool, 2> CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__list_Of_2ibt_FLAG_WriteState(uint8_t concurrentThreadID) {
    ...
    uint8_t CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__List_Of_ThreadToWrite(uint8_t slotID) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE(bool FLAGState) {
        stat_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE(FLAGState);
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_REMAINING(bool FLAGState) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE(bool FLAGState) {
        stat_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE(FLAGState);
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING(bool FLAGState) {
        stat_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING(FLAGState);
    }
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index(uint8_t newValue) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index(uint8_t newValue) {
       stat_REG_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index(newValue);
    }
// private.
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE() {
        _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__isWriteStartThreadRELASE_ONE = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_REMAINING() {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE() {
        _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_ONE = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING() {
        _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_REMAINING = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__3STATE_FLAG_WriteState()
    {
        _stat_REG_CONST_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__2bitFLAG_STATE = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteACTIVE_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteACTIVE_Count_For_ThreadId = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteIDLE_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteIDLE_Count_For_ThreadId = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteWAIT_Count_For_ThreadId()
    {
        _stat_REG_LIST_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteWAIT_Count_For_ThreadId = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_QUE_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__ThreadID_To_WRITE()
    {
        _stat_REG_QUE_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__ThreadID_To_WRITE = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index() {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index() {
        _stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index = nullptr;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE() {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_REMAINING() {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE() {
        _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_ONE = new bool();
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_ONE = true;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING() {
        _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_REMAINING = new bool();
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_REMAINING = true;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__3STATE_FLAG_WriteState()
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__ptr_QUE_Of_ThreadID_To_WRITE(CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Framework* obj)
    {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index() {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index() {
        _stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index = new uint8_t();
        *_stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index = UINT8_MAX;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE() {
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__isWriteStartThreadRELASE_ONE = false;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_REMAINING() {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE() {
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_ONE = false;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING() {
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_REMAINING = false;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__3STATE_FLAG_WriteState()
    {
        _stat_REG_CONST_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__2bitFLAG_STATE = new std::array <std::array<bool, 2>, 3>();
        while (stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__3STATE_FLAG_WriteState() == nullptr) {}
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteACTIVE_Count_For_ThreadId() {
        for (int threadId = 0; threadId < stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteActive_Count_For_ThreadId()->size(); threadId++) {
            auto temp = stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__WriteActive_Count_For_ThreadId()->begin();
            std::advance(temp, threadId);
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index() {
        *_stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index = 0;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index() {
        *_stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index = 0;
    }
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE() {
        return _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__isWriteStartThreadRELASE_ONE;
    }
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_REMAINING() {
    ...
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE() {
        return _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_ONE;
    }
    bool CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING() {
        return _stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_REMAINING;
    }
    ...
    uint8_t* CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index() {
    ...
    uint8_t* CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index() {
        return _stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_ONE(bool newFLAG) {
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__isWriteStartThreadRELASE_ONE = newFLAG;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__isWriteStartThreadRELASE_REMAINING(bool newFLAG) {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_ONE(bool newFLAG) {
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_ONE = newFLAG;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__iswriteEndThreadRELASE_REMAINING(bool newFLAG) {
        *_stat_REG_FLAG_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__FLAG_Control__iswriteEndThreadRELASE_REMAINING = newFLAG;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_set_Item_On_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__3STATE_FLAG_WriteState(uint8_t concurrentThreadID, std::array<bool, 2> new2bitState) {
        auto temp = stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__3STATE_FLAG_WriteState()->begin();
        std::advance(temp, concurrentThreadID);
        *temp = new2bitState;
    }
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_set_Item_On_QUE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__List_Of_ThreadToWrite(uint8_t slotID, uint8_t concurrentThreadID) {
        auto temp = stat_REG_get_ptr_QUE_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__List_Of_ThreadToWrite()->begin();
        std::advance(temp, slotID);
        *temp = concurrentThreadID;
    }
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_WriteStartThreadId_Index(uint8_t newValue)  {
    ...
    void CLIBWriteQueAt_Server_LaunchQueConditionCode::WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control::stat_REG_get_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index(uint8_t newValue)  {
        *_stat_REG_ptr_WriteEnableForThreadsAt_Server_LaunchQueConditionCode__Control__writeCycle_Try_writeEndThreadId_Index = newValue;
    }