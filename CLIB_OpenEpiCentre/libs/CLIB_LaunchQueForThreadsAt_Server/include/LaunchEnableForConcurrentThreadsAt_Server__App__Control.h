...
namespace CLIBLaunchQueAtServer {
    ...
    public:
        ...
        uint64_t dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchActive_Count_For_ThreadID(uint8_t threadID);
        uint64_t dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchIdle_Count_For_ThreadID(uint8_t threadID);
        ...
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchActive_Count_For_ThreadID(uint8_t concurrentThreadId, uint64_t newValue);
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchIdle_Count_For_ThreadID(uint8_t concurrentThreadId, uint64_t newValue);
    ...
    private:
        static std::list<uint64_t>* _stat_REG_LaunchEnableForConcurrentThreadsAt_Server__App__Control__ptr_list_Of_launchActive_Count_For_ThreadID;
        static std::list<uint64_t>* _stat_REG_LaunchEnableForConcurrentThreadsAt_Server__App__Control__ptr_list_Of_launchIdle_Count_For_ThreadID;
        ...
        static std::list<uint64_t>* stat_REG_get_LaunchEnableForConcurrentThreadsAt_Server__ptr_list_Of_launchActive_Count_For_ThreadID();
        static std::list<uint64_t>* stat_REG_get_LaunchEnableForConcurrentThreadsAt_Server__ptr_list_Of_launchIdle_Count_For_ThreadID();
        ...
        static void stat_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchActive_Count_For_ThreadID(uint8_t concurrentThreadId, uint64_t newValue);
        static void stat_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchIdle_Count_For_ThreadID(uint8_t concurrentThreadId, uint64_t newValue);
