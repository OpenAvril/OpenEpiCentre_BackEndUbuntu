...
namespace CLIBLaunchQueAtServer
{
    class LaunchEnableForConcurrentThreadsAt_Server__Control
    {
     public:
        ...
        void dyn_App_LaunchEnableForConcurrentThreadsAt_Server__Control__launchEnable_Request(LaunchEnableForConcurrentThreadsAt_Server__Framework* obj, int32_t concurrentThreadID);
        void dyn_App_LaunchEnableForConcurrentThreadsAt_Server__Control__launchEnable_SortQue(LaunchEnableForConcurrentThreadsAt_Server__Framework* obj, int32_t number_Implemented_Threads);
        void dyn_App_LaunchEnableForConcurrentThreadsAt_Server__Control__launchQue_Update(LaunchEnableForConcurrentThreadsAt_Server__Framework* obj, int32_t number_Implemented_Threads);
        ...
        int32_t dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__concurrentCycle_Try_CoreId_Index();
        bool dyn_REG_get_flag_LaunchEnableForConcurrentThreadsAt_Server__praisinglaunch();
        uint32_t dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchActive_Count_For_ThreadID(int32_t threadID);
        uint32_t dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchIdle_Count_For_ThreadID(int32_t threadID);
        bool dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_STATE_For_ConcurrentCore(int32_t concurrentThreadId);
        int32_t dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_for_Que_Of_CoreTolaunch(int32_t concurrentThreadId);
        int32_t dyn_REG_get_LaunchEnableForConcurrentThreadsAt_Server__new_concurrentCycle_Try_CoreId_Index();
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__concurrentCycle_Try_CoreId_Index(int32_t newValue);
        void dyn_REG_set_flag_LaunchEnableForConcurrentThreadsAt_Server__praisinglaunch(bool newFlag);
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchActive_Count_For_ThreadID(int32_t concurrentThreadId, uint32_t newValue);
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_launchIdle_Count_For_ThreadID(int32_t concurrentThreadId, uint32_t newValue);
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_Of_STATE_For_ConcurrentCore(int32_t concurrentThreadId, bool newState);
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Item_On_list_for_Que_Of_CoreTolaunch(int32_t slot, int32_t concurrentThreadId);
        void dyn_REG_set_LaunchEnableForConcurrentThreadsAt_Server__new_concurrentCycle_Try_CoreId_Index(uint32_t newValue);
    private:
        void dynamicStagger(class LaunchEnableForConcurrentThreadsAt_Server__Framework* obj, int32_t coreId);
        void launchEnable_ShiftQueValues(class LaunchEnableForConcurrentThreadsAt_Server__Framework* obj, int32_t concurrentThreadID_A, int32_t concurrentThreadID_B);
        static int32_t* _stat_REG_ptr_LaunchEnableForConcurrentThreadsAt_Server__Control__concurrentCycle_Try_CoreId_Index;
        ...
        static std::list<int32_t>* _stat_REG_ptr_LaunchEnableForConcurrentThreadsAt_Server__Control__list_for_Que_Of_CoreToLaunch;
        static int32_t* _stat_REG_ptr_LaunchEnableForConcurrentThreadsAt_Server__Control__new_concurrentCycle_Try_CoreId_Index;
        ...
        static int32_t* stat_REG_get_ptr_LaunchEnableForConcurrentThreadsAt_Server__Control__concurrentCycle_Try_CoreId_Index();
        ...
        static std::list<int32_t>* stat_REG_get_ptr_LaunchEnableForConcurrentThreadsAt_Server__Control__List_QUE_Of_CoreTolaunch();
        static int32_t* stat_REG_get_ptr_LaunchEnableForConcurrentThreadsAt_Server__Control__new_concurrentCycle_Try_CoreId_Index();
        static void stat_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Control__concurrentCycle_Try_CoreId_Index(int32_t newValue);
        static void stat_REG_set_flag_LaunchEnableForConcurrentThreadsAt_Server__Control__praisinglaunch(bool newFlag);
        static void stat_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Control__Item_On_list_Of_launchActive_Count_For_ThreadID(int32_t concurrentThreadId, uint32_t newValue);
        static void stat_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Control__Item_On_list_Of_launchIdle_Count_For_ThreadID(int32_t concurrentThreadId, uint32_t newValue);
        static void stat_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Control__Item_On_list_Of_STATE_For_ConcurrentCore(int32_t concurrentThreadId, bool newState);
        static void stat_REG_set_LaunchEnableForConcurrentThreadsAt_Server__Control__Item_On_list_for_Que_Of_CoreTolaunch(int32_t slot, int32_t concurrentThreadId);
