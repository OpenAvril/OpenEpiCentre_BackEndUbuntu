...
namespace CLIBLaunchQueAtServer {
    ...
    public:
        ...
        void dyn_PGM_boot4_INSTANTIATE_LaunchEnableForConcurrentThreadsAt_Server_Execute();
        void* dyn_PGM_get_WriteQueForThreadsAt_ServerLaunchQue_ConditionCode();
        static void stat_CLASS_boot0_DECLARE_LaunchEnableForConcurrentThreadsAt_Server_Execute();
        ...
        static void stat_REG_boot0_DECLARE_LaunchEnableForConcurrentThreadsAt_Server_Execute();
    ...
    private:
        ...
        static void stat_PGM_boot4_INSTANTIATE_LaunchEnableForConcurrentThreadsAt_Server_Execute(class LaunchEnableForConcurrentThreadsAt_Server_Framework* obj);
