...
namespace CLIBLaunchQueAtServer {
    ...
    public:
        ...
        class WriteEnableForThreadsAt_ThreadLogsId_Execute* dyn_CLASS_get_LaunchEnableForConcurrentThreadsAt_Server_Execute();
    ...
    private:
        ...
        static class WriteEnableForThreadsAt_ThreadLogsId_Execute* _stat_CLASS_LaunchEnableForConcurrentThreadsAt_Server_App_Ececute;
        ...
        static class WriteEnableForThreadsAt_ThreadLogsId_Execute* stat_CLASS_get_LaunchEnableForConcurrentThreadsAt_Server_Execute();
    };
}
#endif