...
#include <iterator>
#include <list>
    bool* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_ONE;
    bool* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_REMAINING;
...
// public.
    CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(threadId)."));
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(threadId)."));
    }
    CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::~WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control() {
        std::cout << "thread "  << 0 << " :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(threadId)."));
        ...
        std::cout << "thread "  << 0 << " :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_dynamicIn(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj, uint8_t coreId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_dynamicIn(threadId)."));
        ...
        if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId) == coreId) {
            ...
            while (!obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)) {

            }
        }
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_dynamicIn(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_dynamicOut(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj, uint8_t coreId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_dynamicOut(threadId)."));
        ...
        if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId) == coreId) {
            ...
            while (!obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)) {

            }
        }
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_dynamicOut(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_Activate(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj, uint8_t coreId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_Activate(threadId)."));
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_2ibt_FLAG_WriteState(threadId, coreId, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerInputReceive_2bitFLAG_WAIT(threadId));
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_Activate(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_ShiftQueValues(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj, uint8_t coreId_A, uint8_t coreId_B) {
        ...
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId,coreId_A, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId, coreId_B));
        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId,coreId_B, temp_B);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_ShiftQueValues(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_SortQue(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_SortQue(threadId)."));
        for (uint8_t index_A = 0; index_A < (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_WriteEnableForThreadsAt_ServerInputReceive_number_Of_Implemented_Threads(threadId) - 1); index_A++)
        {
            for (uint8_t index_B = (index_A + 1); index_B < obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_WriteEnableForThreadsAt_ServerInputReceive_number_Of_Implemented_Threads(threadId); index_B++)
            {
                if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_2ibt_FLAG_WriteState(threadId, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId, index_A)) == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerInputReceive_2bitFLAG_WRITE(threadId))
                {
                ...
                else if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_2ibt_FLAG_WriteState(threadId, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId, index_A)) == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerInputReceive_2bitFLAG_IDLE(threadId))
                {
                    if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_2ibt_FLAG_WriteState(threadId, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId, index_B)) == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerInputReceive_2bitFLAG_IDLE(threadId))
                    {
                        if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteIdle_Count_For_threadId(threadId, index_A) < obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteIdle_Count_For_threadId(threadId, index_B))
                ...
                else if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_2ibt_FLAG_WriteState(threadId, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId, index_A)) == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerInputReceive_2bitFLAG_WAIT(threadId))
                {
                    if (obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_2ibt_FLAG_WriteState(threadId, obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId, index_B)) == obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Global(threadId)->dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerInputReceive_2bitFLAG_IDLE(threadId))
                    {
                        obj->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_App_Control(threadId)->dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeEnable_ShiftQueValues(threadId, obj, index_A, index_B);
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeQue_Update(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeQue_Update(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(threadId)."));
        stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId);
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(threadId)."));
        stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId);
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(uint8_t threadId, WriteEnableForThreadsAt_ServerInputReceive_Framework* obj) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control(threadId)."));
        stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId);
    ...
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
        return stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId);
    }
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
    ...
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
    ...
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
    ...
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)."));
    ...
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)."));
    ...
    std::array<bool, 2> CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_2ibt_FLAG_WriteState(uint8_t threadId, uint8_t concurrentthreadId) {
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_2ibt_FLAG_WriteState(threadId)."));
        return *temp;
    }
    unsigned long long CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteActive_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId) {
        ...
        std::advance(temp, concurrentthreadId);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteActive_Count_For_threadId(threadId)."));
        return *temp;
    }
    unsigned long long CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteIdle_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId) {
        ...
        std::advance(temp, concurrentthreadId);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteIdle_Count_For_threadId(threadId)."));
        return *temp;
    }
    unsigned long long CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteWait_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId) {
        ...
        std::advance(temp, concurrentthreadId);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_list_Of_WriteWait_Count_For_threadId(threadId)."));
        return *temp;
    }
    uint8_t CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(uint8_t threadId, uint8_t slotID) {
        ...
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= bool : dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId)."));
        return *temp;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(uint8_t threadId, bool FLAGState) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
        stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId,FLAGState);
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(uint8_t threadId, bool FLAGState) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
        stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId,FLAGState);
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(uint8_t threadId, bool FLAGState) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
        stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId,FLAGState);
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(uint8_t threadId, bool FLAGState) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_2ibt_FLAG_WriteState(uint8_t threadId, uint8_t concurrentthreadId, std::array<bool, 2> new2bitState) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_2ibt_FLAG_WriteState(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteActive_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId, unsigned long long newCount) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteActive_Count_For_threadId(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId, unsigned long long newCount) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId, unsigned long long newCount){
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(uint8_t threadId, uint8_t slotID, uint8_t newID){
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(uint8_t threadId, uint8_t newValue) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(uint8_t threadId, uint8_t newValue) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : dyn_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)."));
...
// private.
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
        _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_ONE = nullptr;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
        _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_REMAINING = nullptr;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
        _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteEndThreadRELASE_ONE = nullptr;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
        _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteEndThreadRELASE_REMAINING = nullptr;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteACTIVE_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteACTIVE_Count_For_threadId(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIDLE_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIDLE_Count_For_threadId(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWAIT_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWAIT_Count_For_threadId(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_QUE_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_threadId_To_WRITE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_QUE_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_threadId_To_WRITE(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot2_SUBSTANTIATE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)."));
        _stat_REG_CONST_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_2bitFLAG_STATE = new std::array<std::array<bool, 2>, 3>();
        while (stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId) == nullptr) {}
        _stat_REG_CONST_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_2bitFLAG_STATE->at(0) = { true, true };
        _stat_REG_CONST_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_2bitFLAG_STATE->at(1) = { true, true };
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
        *_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_ONE = false;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
        *_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_REMAINING = false;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
        *_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteEndThreadRELASE_ONE = false;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
        *_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteEndThreadRELASE_REMAINING = false;
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: exiting LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)."));
        _stat_REG_CONST_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_2bitFLAG_STATE = new std::array <std::array<bool, 2>, 3>();
        while (stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId) == nullptr) {}
        stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)->at(0) = { false, false };
        stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)->at(1) = { false, true };
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteACTIVE_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteACTIVE_Count_For_threadId(threadId)."));
        for (int threadId = 0; threadId < stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteActive_Count_For_threadId(threadId)->size(); threadId++) {
            auto temp = stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteActive_Count_For_threadId(threadId)->begin();
            std::advance(temp, threadId);
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIDLE_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIDLE_Count_For_threadId(threadId)."));
        for (int threadId = 0; threadId < stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(threadId)->size(); threadId++) {
            auto temp = stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(threadId)->begin();
            std::advance(temp, threadId);
            *temp = static_cast<unsigned long long>(0);
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWAIT_Count_For_threadIdd(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWAIT_Count_For_threadIdd(threadId)."));
        for (int threadId = 0; threadId < stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(threadId)->size(); threadId++) {
            auto temp = stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(threadId)->begin();
            std::advance(temp, threadId);
            *temp = static_cast<unsigned long long>(0);
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_ptr_QUE_Of_threadId_To_WRITE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_ptr_QUE_Of_threadId_To_WRITE(threadId)."));
        for (int threadId = 0; threadId < stat_REG_get_ptr_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId)->size(); threadId++) {
            auto temp = stat_REG_get_ptr_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId)->begin();
            std::advance(temp, threadId);
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: entered LIB :: CLIBWriteQueAtServerInputReceive : WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)."));
    ...
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
        return _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_ONE;
    }
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
        return _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_REMAINING;
    }
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
        return _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteEndThreadRELASE_ONE;
    }
    bool CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
        return _stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteEndThreadRELASE_REMAINING;
    }
    std::array<std::array<bool, 2>, 3>* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)."));
    ...
    std::list<unsigned long long>* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteActive_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteActive_Count_For_threadId(threadId)."));
    ...
    std::list<unsigned long long>* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(threadId)."));
    ...
    std::list<unsigned long long>* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(threadId)."));
    ...
    std::list<uint8_t>* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_ptr_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId)."));
    ...
    uint8_t* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)."));
    ...
    uint8_t* CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(uint8_t threadId) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(uint8_t threadId,bool newFLAG) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_ONE(threadId)."));
        *_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_ONE = newFLAG;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(uint8_t threadId,bool newFLAG) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteStartThreadRELASE_REMAINING(threadId)."));
        *_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteStartThreadRELASE_REMAINING = newFLAG;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(uint8_t threadId,bool newFLAG) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_ONE(threadId)."));
        *_stat_REG_FLAG_WriteEnableForThreadsAt_ServerInputReceive_FLAG_Control_isWriteEndThreadRELASE_ONE = newFLAG;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(uint8_t threadId, bool newFLAG) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => bool : stat_REG_set_FLAG_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_isWriteEndThreadRELASE_REMAINING(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_Item_On_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(uint8_t threadId, uint8_t concurrentthreadId, std::array<bool, 2> new2bitState) {
        auto temp = stat_REG_get_ptr_Array_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)->begin();
        std::advance(temp, concurrentthreadId);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => std::array<bool, 2> : stat_REG_set_Item_On_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_3STATE_FLAG_WriteState(threadId)."));
        *temp = new2bitState;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteACTIVE_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId, unsigned long long newCount) {
        auto temp = stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteActive_Count_For_threadId(threadId)->begin();
        std::advance(temp, concurrentthreadId);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => unsigned long long : stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteACTIVE_Count_For_threadId(threadId)."));
        *temp = newCount;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId, unsigned long long newCount) {
        auto temp = stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(threadId)->begin();
        std::advance(temp, concurrentthreadId);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => unsigned long long : stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteIdle_Count_For_threadId(threadId)."));
        *temp = newCount;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(uint8_t threadId, uint8_t concurrentthreadId, unsigned long long newCount) {
        auto temp = stat_REG_get_ptr_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(threadId)->begin();
        std::advance(temp, concurrentthreadId);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => unsigned long long : stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_WriteWait_Count_For_threadId(threadId)."));
        *temp = newCount;
    }
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(uint8_t threadId, uint8_t slotID, uint8_t concurrentthreadId) {
        auto temp = stat_REG_get_ptr_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId)->begin();
        std::advance(temp, slotID);
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => uint8_t : stat_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_List_Of_ThreadToWrite(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(uint8_t threadId, uint8_t newValue) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: => uint8_t : stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteStartthreadId_Index(threadId)."));
    ...
    void CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control::stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(uint8_t threadId, uint8_t newValue) {
        CLIB_ThreadLogs::CLIB_ThreadLogs::stat_APP_FUNCT_CLIB_ThreadLogs_printConsoleAndLog(threadId, new std::string(" :: <= uint8_t : stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive_Framework_App_Control_writeCycle_Try_WriteEndthreadId_Index(threadId)."));
