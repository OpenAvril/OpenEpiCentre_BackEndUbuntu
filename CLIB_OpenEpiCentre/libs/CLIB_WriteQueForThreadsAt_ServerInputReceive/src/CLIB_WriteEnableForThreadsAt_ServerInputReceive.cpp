...
void* CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::app_FUNCT_generate_Program()
{
	...
	stat_REG_boot1_DEFINE_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED();
	stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED();
	stat_REG_boot3_INITIALISE_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED();
...
{
	if (stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[1] == false) {
		return CLIBWriteQueAtServerInputReceive::WriteEnableForThreadsAt_ServerInputReceive_Global::stat_CONVERT_bool_to_ByteArray(stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[0]);
	}
	else {
		stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[1] = false;
...
{
	if (stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[2] == false) {
		delete _stat_REG_ptr_Framework_WriteEnableForThreadsAt_ServerInputReceive;
		while (stat_CLASS_get_ptr_Framework() != nullptr) {}
	}
	else {
		stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[2] = false;
	}
...
{
	if (stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[3] == false) {
		...
		stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[3] = false;
	}
}
...
{
	if (stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[4] == false) {
		...
		stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[4] = false;
...
{
	stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[0] = false;
	...
	{
		if (stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[memberFunctionId] == true)
		{
			stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()[0] = true;
		}
	}
}
...
void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::stat_REG_boot1_DEFINE_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()
{
	_stat_REG_flag_isMemberFunctionINSTANTIATED = NULL;
}
void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()
{
	_stat_REG_flag_isMemberFunctionINSTANTIATED = new bool[5]();
	while (stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED() == NULL) {}
	for (uint8_t index = 0; index < sizeof(*stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()); index++)
	{
		_stat_REG_flag_isMemberFunctionINSTANTIATED[index] = true;
	}
}
void CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::stat_REG_boot3_INITIALISE_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()
{
	for (uint8_t index = 0; index < sizeof(*stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()); index++)
	{
		_stat_REG_flag_isMemberFunctionINSTANTIATED[index] = true;
...
bool* CLIBWriteQueAtServerInputReceive::CLIB_WriteEnableForThreadsAt_ServerInputReceive::stat_REG_get_CLIBLaunchQueAtServerInputReceive_isFlagINSTANTIATED()
{
