...
namespace CLIBWriteQueAtServerInputReceive
{
    ...
    public:
        ...
        static int stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__Bool_To_Int(bool value);
        static unsigned char* stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbBoolean_To_MsbByteArray(bool value);
        static bool stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbBoolean(const unsigned char* byteArray);
        static std::byte stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbByte(const unsigned char* byteArray);
        static double stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbDouble(const unsigned char* byteArray);
        static float stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbFloat(const unsigned char* byteArray);
        static unsigned long long stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbunsignedLongLong(const unsigned char* byteArray);
        static unsigned char* stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByte_To_MsbByteArray(const std::byte byte);
        static unsigned char* stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbFloat_To_MsbByteArray(float value);
        static unsigned char* stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbDouble_To_MsbByteArray(double value);
        static unsigned char* stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__unsignedLongLong_to_ByteArray(unsigned long long value);
    private:
        ...
        static int pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__Bool_To_Int(bool value);
        static unsigned char* pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbBoolean_To_MsbByteArray(bool value);
        static bool pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbBoolean(const unsigned char* byteArray);
        static std::byte* pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbByte(const unsigned char* byteArray);
        static double pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbDouble(const unsigned char* byteArray);
        static float pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbFloat(const unsigned char* byteArray);
        static unsigned long long pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbByteArray_To_MsbunsignedLongLong(const unsigned char* byteArray);
        static unsigned char* pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbFloat_To_MsbByteArray(float value);
        static unsigned char* pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbDouble_To_MsbByteArray(double value);
        static unsigned char* pr_stat_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__Msb_unsignedLongLong_to_MsbByteArray(unsigned long long value);
