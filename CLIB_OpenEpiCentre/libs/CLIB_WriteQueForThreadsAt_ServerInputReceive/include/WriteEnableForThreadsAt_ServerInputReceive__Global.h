...
namespace CLIBWriteQueAtServerInputReceive {
    ...
    public:
        ...
        static unsigned char* stat_APP_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbFloat_To_MsbByteArray(float value);
        static unsigned char* stat_APP_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__MsbDouble_To_MsbByteArray(double value);
        static unsigned char* stat_APP_CONVERT_WriteEnableForThreadsAt_ServerInputReceive__Msb_uint8_t_to_MsbByteArray(uint8_t value);
