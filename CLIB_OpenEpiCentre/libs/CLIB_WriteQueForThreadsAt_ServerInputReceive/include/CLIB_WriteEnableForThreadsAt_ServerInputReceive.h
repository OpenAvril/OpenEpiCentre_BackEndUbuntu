...
extern "C"
{
    namespace CLIBWriteQueAtServerInputReceive
    {
        ...
        public:
            ...
            static void CLIB_WriteEnableForThreadsAt_ServerInputReceive__App_FUNCT_set_flag_isCurrentThreadRELEASED(unsigned char* bytes);
        ...
        private:
            ...
            static void CLIB_WriteEnableForThreadsAt_ServerInputReceive__stat_App_FUNCT_set_flag_isCurrentThreadRELEASED(bool bytes);
