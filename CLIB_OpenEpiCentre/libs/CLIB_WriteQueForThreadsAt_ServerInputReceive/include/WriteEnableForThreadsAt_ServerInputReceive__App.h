...
namespace CLIBWriteQueAtServerInputReceive
{
    ...
    public:
        ...
        void dyn_APP_FUNCT_write_End(WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, int32_t coreId);
        void dyn_APP_FUNCT_write_Start(WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, int32_t coreId);
