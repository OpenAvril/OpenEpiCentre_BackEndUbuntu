...
namespace CLIBWriteQueAtServerInputReceive
{
    ...
    public:
        ...
        void dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive__Control__dynamicStagger(class WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, int32_t coreId);
        void dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive__Control__writeEnable_Activate(class WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, int32_t coreId);
        void dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive__Control__writeEnable_ShiftQueValues(class WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, int32_t coreId_A, int32_t coreId_B);
        ...
        void dyn_APP_FUNCT_WriteEnableForThreadsAt_ServerInputReceive__Control__writeEnable_Request(class WriteEnableForThreadsAt_ServerInputReceive__Framework* obj, int32_t coreId);
        ...
        std::array<bool, 2> dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__list_Of_2ibt_flag_WriteState(int32_t concurrentThreadID);
        uint32_t dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive__Control__list_Of_WriteActive_Count_For_ThreadId(int32_t concurrentThreadID);
        uint32_t dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive__Control__list_Of_WriteIdle_Count_For_ThreadId(int32_t concurrentThreadID);
        uint32_t dyn_REG_get_Item_On_WriteEnableForThreadsAt_ServerInputReceive__Control__list_Of_WriteWait_Count_For_ThreadId(int32_t concurrentThreadID);
        int32_t dyn_REG_get_Item_WriteEnableForThreadsAt_ServerInputReceive__Control__new_writeCycle_Try_ThreadId_Index();
        int32_t dyn_REG_get_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive__Control__List_Of_ThreadToWrite(int32_t slotID);
        int32_t dyn_REG_get_Item_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_ThreadId_Index();
        void dyn_REG_set_flag_WriteEnableForThreadsAt_ServerInputReceive__Control__praisingWrite(bool newBoolValue);
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__2ibt_flag_WriteState(int32_t concurrentThreadID, std::array<bool, 2> new2bitState);
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__WriteActive_Count_For_ThreadId(int32_t concurrentThreadID, uint32_t newCount);
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__WriteIdle_Count_For_ThreadId(int32_t concurrentThreadID, uint32_t newCount);
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__WriteWait_Count_For_ThreadId(int32_t concurrentThreadID, uint32_t newCount);
        void dyn_REG_set_WriteEnableForThreadsAt_ServerInputReceive__Control__new_writeCycle_Try_ThreadId_Index(int32_t newID);
        void dyn_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive__Control__List_Of_ThreadToWrite(int32_t slotID, int32_t newID);
        void dyn_REG_set_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_ThreadId_Index(int32_t newID);
    ...
    private:
        ...
        static int32_t* _stat_REG_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__new_writeCycle_Try_ThreadId_Index;
        static std::list<int32_t>* _stat_REG_QUE_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__ThreadID_To_WRITE;
        static int32_t* _stat_REG_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_ThreadId_Index;
        ...
        static int32_t* stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__new_writeCycle_Try_ThreadId_Index();
        static std::list<int32_t>* stat_REG_get_ptr_QUE_WriteEnableForThreadsAt_ServerInputReceive__Control__List_Of_ThreadToWrite();
        static int32_t* stat_REG_get_ptr_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_ThreadId_Index();
        ...
        static void stat_REG_set_Item_On_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__3STATE_flag_WriteState(int32_t concurrentThreadID, std::array<bool, 2> new2bitState);
        static void stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__WriteACTIVE_Count_For_ThreadId(int32_t concurrentThreadID, uint32_t newCount);
        static void stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__WriteIdle_Count_For_ThreadId(int32_t concurrentThreadID, uint32_t newCount);
        static void stat_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerInputReceive__Control__WriteWait_Count_For_ThreadId(int32_t concurrentThreadID, uint32_t newCount);
        static void stat_REG_set_WriteEnableForThreadsAt_ServerInputReceive__Control__new_writeCycle_Try_ThreadId_Index(int32_t newValue);
        static void stat_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerInputReceive__Control__List_Of_ThreadToWrite(int32_t slotID, int32_t concurrentThreadID);
        static void stat_REG_set_WriteEnableForThreadsAt_ServerInputReceive__Control__writeCycle_Try_ThreadId_Index(int32_t newValue);
