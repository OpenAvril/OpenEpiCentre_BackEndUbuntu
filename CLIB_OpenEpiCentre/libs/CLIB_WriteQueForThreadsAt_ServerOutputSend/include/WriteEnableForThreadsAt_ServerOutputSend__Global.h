...
namespace CLIBWriteQueAtServerOutputSend
{
    ...
    public:
        ...
        uint64_t dyn_REG_get_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads();
        ...
        unsigned char* stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__Msb_uint64_t_to_MsbByteArray(uint64_t value);
        ...
        static uint64_t stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_Msbuint64_t(const unsigned char* byteArray);
    private:
        ...
        static uint64_t* _stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads;
        ...
        static uint64_t pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_Msbuint64_t(const unsigned char* byteArray);
        ...
        static unsigned char* pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__Msb_uint64_t_to_MsbByteArray(uint64_t value);
        ...
        static uint64_t* stat_REG_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads();
    };
}
#endif