...
namespace CLIBWriteQueAtServerOutputSend
{
    ...
    public:
        ...
        unsigned long long dyn_REG_get_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads();
        ...
        unsigned char* stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__Msb_unsignedLongLong_to_MsbByteArray(unsigned long long value);
        ...
        static unsigned long long stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbunsignedLongLong(const unsigned char* byteArray);
    private:
        ...
        static unsigned long long pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbunsignedLongLong(const unsigned char* byteArray);
        ...
        static unsigned char* pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__Msb_unsignedLongLong_to_MsbByteArray(unsigned long long value);
