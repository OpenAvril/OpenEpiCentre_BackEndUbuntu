...
namespace CLIBWriteQueAtServerOutputSend
{
    ...
    public:
        ...
        std::array<bool, 2> dyn_REG_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__Control__list_Of_2ibt_flag_WriteState(std::byte concurrentThreadId);
        ...
        void dyn_REG_set_Item_On_list_Of_WriteEnableForThreadsAt_ServerOutputSend__Control__2ibt_flag_WriteState(std::byte concurrentThreadId, std::array<bool, 2> new2bitState);
    ...
    private:
        ...
        static unsigned long long* _stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__Control__new_writeCycle_Try_ThreadId_Index;
        static std::list<unsigned long>* _stat_REG_QUE_Of_WriteEnableForThreadsAt_ServerOutputSend__Control__ThreadID_To_WRITE;
        static unsigned long long* _stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__Control__writeCycle_Try_ThreadId_Index;
        ...
        static unsigned long long* stat_REG_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__Control__new_writeCycle_Try_ThreadId_Index();
        ...
        static unsigned long long* stat_REG_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__Control__writeCycle_Try_ThreadId_Index();
        ...
        static void stat_REG_set_Item_On_QUE_WriteEnableForThreadsAt_ServerOutputSend__Control__List_Of_ThreadToWrite(unsigned long long slotID, std::byte concurrentThreadId);
