#ifndef CLIB_WriteEnableForThreadsAt_ServerOutputSend_WriteEnableForThreadsAt_ServerOutputSend_Global_H
#define CLIB_WriteEnableForThreadsAt_ServerOutputSend_WriteEnableForThreadsAt_ServerOutputSend_Global_H
#include <array>
#include <cstdint>
extern "C" {
    namespace CLIBWriteQueAtServerOutputSend
    {
        ...
        public:
            ...
            ~WriteEnableForThreadsAt_ServerOutputSend_Global();
            void boot1_REG_DEFINE_WriteEnableForThreadsAt_ServerOutputSend_Global();
            void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_ServerOutputSend_Global();
            void boot3_REG_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend_Global();
            void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_ServerOutputSend_Global();
            ...
            static void boot0_CLASS_DECLARE_WriteEnableForThreadsAt_ServerOutputSend_Global();
            ...
            static void boot0_REG_DECLARE_WriteEnableForThreadsAt_ServerOutputSend_Global();
