...
// public.
    CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
    }
    CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::~WriteEnableForThreadsAt_ServerOutputSend_Framework_Global() {
        std::cout << "thread "  << 0 << " :: thread ?" << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Framework : WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
        ...
        std::cout << "thread "  << 0 << " :: thread ?" << " :: exiting LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Framework : WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
    }
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
    }
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend_Global(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= CONST : dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= CONST : dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= CONST : dyn_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= uint8_t : dyn_REG_get_WriteEnableForThreadsAt_ServerOutputSend_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= int : stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Bool_To_Int(threadId)." << std::endl;
    ...
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msbdouble_To_MsbByteArray(uint8_t threadId, double value) {
        std::cout << "thread "  << threadId << " :: <= unsigned char* : stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msbdouble_To_MsbByteArray(threadId)." << std::endl;
    ...
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msb_uint8_t_to_MsbByteArray(uint8_t threadId, uint8_t value) {
        std::cout << "thread "  << threadId << " :: <= unsigned char* : stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msb_uint8_t_to_MsbByteArray(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= unsigned char* : stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbBoolean_To_MsbByteArray(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= bool : stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_MsbBoolean(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= double : stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_MsbDouble(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= uint8_t : stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_Msbuint8_t(threadId)." << std::endl;
...
// private.
    int CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Bool_To_Int(uint8_t threadId, bool value) {
        ...
        *temp = 2;
        ...
        std::cout << "thread "  << threadId << " :: <= int : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Bool_To_Int(threadId)." << std::endl;
        return *temp;
    }
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbBoolean_To_MsbByteArray(uint8_t threadId, bool value) {
        ...
        std::cout << "thread "  << threadId << " :: <= unsigned char* : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbBoolean_To_MsbByteArray(threadId)." << std::endl;
        return buffer;
    }
    bool CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_MsbBoolean(uint8_t threadId, const unsigned char* byteArray) {
        std::cout << "thread "  << threadId << " :: <= bool : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_MsbBoolean(threadId)." << std::endl;
    ...
    double CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_MsbDouble(uint8_t threadId, const unsigned char* byteArray) {
        ...
        std::cout << "thread "  << threadId << " :: <= double : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_MsbDouble(threadId)." << std::endl;
        return temp;
    }
    double CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_Msbdouble(uint8_t threadId, const unsigned char* byteArray) {
        double temp;
    ...
    uint8_t CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_Msbuint8_t(uint8_t threadId, const unsigned char* byteArray) {
        ...
        std::cout << "thread "  << threadId << " :: <= uint8_t : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbByteArray_To_Msbuint8_t(threadId)." << std::endl;
        return temp;
    }
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msbdouble_To_MsbByteArray(uint8_t threadId, double value) {
        ...
        std::cout << "thread "  << threadId << " :: <= unsigned char* : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msbdouble_To_MsbByteArray(threadId)." << std::endl;
        return buffer;
    }
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_MsbDouble_To_MsbByteArray(uint8_t threadId, double value) {
        unsigned char* buffer = nullptr;
    ...
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msb_uint8_t_to_MsbByteArray(uint8_t threadId, uint8_t value) {
        ...
        std::cout << "thread "  << threadId << " :: <= unsigned char* : pr_stat_APP_CONVERT_WriteEnableForThreadsAt_ServerOutputSend_Msb_uint8_t_to_MsbByteArray(threadId)." << std::endl;
        return buffer;
    }
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WAIT(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot1_DEFINE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerOutputSend_number_Of_Implemented_Threads(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot1_DEFINE_ptr_WriteEnableForThreadsAt_ServerOutputSend_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WAIT(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot2_SUBSTANTIATE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot2_SUBSTANTIATE_ptr_WriteEnableForThreadsAt_ServerOutputSend_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend_Framework_Global::stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(uint8_t threadId) {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(threadId)." << std::endl;
        *_stat_REG_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE = {true, true};
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot3_INITIALISE_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(threadId)." << std::endl;
    }
    ...
    {
        std::cout << "thread "  << threadId << " :: entered LIB :: CLIBWriteQueAtServerOutputSend : WriteEnableForThreadsAt_ServerOutputSend_Global : stat_REG_boot3_INITIALISE_ptr_WriteEnableForThreadsAt_ServerOutputSend_number_Of_Implemented_Threads(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= std::array<bool,2>* : stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_IDLE(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= std::array<bool,2>* : stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WAIT(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= std::array<bool,2>* : stat_REG_get_ptr_CONST_WriteEnableForThreadsAt_ServerOutputSend_2bitFLAG_WRITE(threadId)." << std::endl;
    ...
    {
        std::cout << "thread "  << threadId << " :: <= uint8_t* : stat_REG_get_ptr_WriteEnableForThreadsAt_ServerOutputSend_number_Of_Implemented_Threads(threadId)." << std::endl;
