...
// public.
	void* CLIBWriteQueAtServerOutputSend::CLIB_WriteEnableForThreadsAt_ServerOutputSend::CLIB_WriteEnableForThreadsAt_ServerOutputSend__App_FUNCT_generate_Program()	{
		...
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_create_WriteEnableForThreadsAt_ServerOutputSend__Global_and_Settings();
		...
		CLIB_WriteEnableForThreadsAt_ServerOutputSend__stat_CLASS_get_ptr_Framework()->dyn_CLASS_create_WriteEnableForThreadsAt_ServerOutputSend__Architecture();
