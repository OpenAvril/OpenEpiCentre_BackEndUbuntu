...
#include <iostream>
#include <ostream>
    CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Control* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::_stat_CLASS_ptr_WriteEnable__Control = NULL;
    ...
    {
        CLASS_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend();
        CLASS_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend();
        CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend();
    }
    CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::~WriteEnableForThreadsAt_ServerOutputSend__App()
    {
        delete _stat_CLASS_ptr_WriteEnable__Control;
    }
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::CLASS_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend()
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::CLASS_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend()
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend()
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend()
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend(CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Framework* obj)
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerOutputSend(CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Framework* obj)
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend(CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Framework* obj)
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_ServerOutputSend(CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::dyn_APP_FUNCT_write_End(CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::dyn_APP_FUNCT_write_Start(CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::stat_CLASS_boot1_DEFINE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = NULL;
    }

    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::stat_CLASS_boot3_INITIALISE_WriteEnable__Control()
    {
        _stat_CLASS_ptr_WriteEnable__Control = new class CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Control();
        while (stat_CLASS_get_ptr_WriteEnable__Control() == NULL) {}
    }
    CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Control* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::stat_CLASS_get_ptr_WriteEnable__Control()
    {
