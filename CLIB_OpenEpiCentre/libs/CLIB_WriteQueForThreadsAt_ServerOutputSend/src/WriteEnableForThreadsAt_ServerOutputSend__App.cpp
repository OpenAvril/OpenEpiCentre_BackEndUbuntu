...
#include <ostream>
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::dyn_APP_FUNCT_write_End(WriteEnableForThreadsAt_ServerOutputSend__Framework* obj, int32_t coreId)
    {
    ...
    void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__App::dyn_APP_FUNCT_write_Start(WriteEnableForThreadsAt_ServerOutputSend__Framework* obj, int32_t coreId)
    {
