...
#include <cstring>
#include <iostream>
std::array<bool,2>* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::_stat_REG_CONST_WriteEnableForThreadsAt_ServerOutputSend__2bitFLAG_IDLE;
std::array<bool,2>* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::_stat_REG_CONST_WriteEnableForThreadsAt_ServerOutputSend__2bitFLAG_WAIT;
std::array<bool,2>* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::_stat_REG_CONST_WriteEnableForThreadsAt_ServerOutputSend__2bitFLAG_WRITE;
std::byte* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::_stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads;
...
std::byte CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::dyn_REG_get_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads()
{
    return *stat_REG_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads();
}
    int CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__Bool_To_Int(bool value)
    {
        int* temp = nullptr;
        *temp = 2;
        if (value) {
    ...
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbBoolean_To_MsbByteArray(bool value)
    {
    ...
    bool CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbBoolean(const unsigned char* byteArray)
    {
        return (byteArray[7] & 1) != 0;
    }
    std::byte CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbByte(const unsigned char* byteArray)
    {
        std::byte temp;
        std::memcpy(&temp, byteArray, sizeof(std::byte));
        return temp;
    }
    double CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbDouble(const unsigned char* byteArray)
    {
        double temp;
        std::memcpy(&temp, byteArray, sizeof(double));
        return temp;
    }
    float CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbFloat(const unsigned char* byteArray)
    {
        float temp;
        std::memcpy(&temp, byteArray, sizeof(float));
        return temp;
    }
    unsigned long long CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbunsignedLongLong(const unsigned char* byteArray)
    {
        unsigned long long temp;
        std::memcpy(&temp, byteArray, sizeof(unsigned long));
        return temp;
    }
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByte_To_MsbByteArray(std::byte byte) {
        unsigned char* temp;
        std::memcpy(&temp, &byte, sizeof(std::byte));
        return temp;
    }
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbFloat_To_MsbByteArray(float value)
    {
        unsigned char* buffer = nullptr;
        std::memcpy(buffer, &value, sizeof(float));
        return buffer;
    }
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbDouble_To_MsbByteArray(double value)
    {
        unsigned char* buffer = nullptr;
        std::memcpy(buffer, &value, sizeof(double));
        return buffer;
    }
    unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__unsignedLongLong_to_ByteArray(unsigned long long value)
    {
        unsigned char* buffer = nullptr;
        std::memcpy(buffer, &value, sizeof(unsigned long));
        return buffer;
    }
int CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__Bool_To_Int(bool value) {
    int* temp = nullptr;
    *temp = 2;
    if (value) {
        *temp = 1;;
...
unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbBoolean_To_MsbByteArray(bool value) {
    unsigned char* buffer = nullptr;
...
bool CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbBoolean(const unsigned char* byteArray) {
    return (byteArray[7] & 1) != 0;
}
std::byte* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbByte(const unsigned char* byteArray)
{
    std::byte* temp;
    std::memcpy(&temp, byteArray, sizeof(std::byte));
    return temp;
}
double CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbDouble(const unsigned char* byteArray) {
    double temp;
    std::memcpy(&temp, byteArray, sizeof(double));
    return temp;
}
float CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbFloat(const unsigned char* byteArray) {
    float temp;
    std::memcpy(&temp, byteArray, sizeof(float));
    return temp;
}
unsigned long long CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbByteArray_To_MsbunsignedLongLong(const unsigned char* byteArray) {
    unsigned long long temp;
    std::memcpy(&temp, byteArray, sizeof(unsigned long));
    return temp;
}
unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbFloat_To_MsbByteArray(float value) {
    unsigned char* buffer = nullptr;
    buffer = new unsigned char[4] { UCHAR_MAX, UCHAR_MAX, UCHAR_MAX, UCHAR_MAX};
    std::memcpy(buffer, &value, sizeof(float));
    return buffer;
}
unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__MsbDouble_To_MsbByteArray(double value) {
    unsigned char* buffer = nullptr;
    buffer = new unsigned char[8] { UCHAR_MAX, UCHAR_MAX, UCHAR_MAX, UCHAR_MAX, UCHAR_MAX, UCHAR_MAX, UCHAR_MAX, UCHAR_MAX};
    std::memcpy(buffer, &value, sizeof(double));
    return buffer;
}
unsigned char* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::pr_stat_CONVERT_WriteEnableForThreadsAt_ServerOutputSend__Msb_unsignedLongLong_to_MsbByteArray(unsigned long long value) {
    unsigned char* buffer = nullptr;
...
{
    _stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads = new std::byte();
    *_stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads = static_cast<std::byte>(255);
}
...
{
    *_stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads = static_cast<std::byte>(4);
}
...
std::byte* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::stat_REG_get_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads()
{
