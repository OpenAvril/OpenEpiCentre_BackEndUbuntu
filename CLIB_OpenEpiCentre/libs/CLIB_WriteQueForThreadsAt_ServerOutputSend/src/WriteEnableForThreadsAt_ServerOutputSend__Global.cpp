...
uint8_t* CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::_stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads;
...
void CLIBWriteQueAtServerOutputSend::WriteEnableForThreadsAt_ServerOutputSend__Global::dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend__Global()
{
    std::cout << "entered dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend__Global()." << std::endl;
    std::cout << "exiting dyn_REG_boot0_DECLARE_WriteEnableForThreadsAt_ServerOutputSend__Global()." << std::endl;
}
...
{
    std::cout << "entered dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend__Global()." << std::endl;
    ...
    std::cout << "exiting dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_ServerOutputSend__Global()." << std::endl;
}
...
{
    std::cout << "entered dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerOutputSend__Global()." << std::endl;
    ...
    std::cout << "exiting dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_ServerOutputSend__Global()." << std::endl;
}
...
{
    std::cout << "entered dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend__Global()" << std::endl;
    ...
    std::cout << "exiting dyn_REG_boot3_INITIALISE_WriteEnableForThreadsAt_ServerOutputSend__Global()" << std::endl;
}
...
{
    _stat_REG_CONST_WriteEnableForThreadsAt_ServerOutputSend__2bitFLAG_IDLE = new std::array<bool, 2>();
...
{
    _stat_REG_CONST_WriteEnableForThreadsAt_ServerOutputSend__2bitFLAG_WAIT = new std::array<bool, 2>();
...
{
    _stat_REG_CONST_WriteEnableForThreadsAt_ServerOutputSend__2bitFLAG_WRITE = new std::array<bool, 2>();
...
{
    _stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads = new uint8_t();
    *_stat_REG_ptr_WriteEnableForThreadsAt_ServerOutputSend__number_Of_Implemented_Threads = UINT8_MAX;
}
