...
#include <iostream>
#include <span>
	CLIBOpenEpiCentre::WriteEnableForThreadsAt_DataStack_Framework* _stat_REG_ptr_Framework_WriteEnableForThreadsAt_DataStack;
	std::array<bool, 5>* _stat_REG_FLAG_CLIB_WriteEnableForThreadsAt_DataStack_isMemberFunctionINSTANTIATED;
// public.
	class CLIBOpenEpiCentre::WriteEnableForThreadsAt_DataStack_Framework* CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_generate_Program(uint8_t threadId)	{
		std::cout << "thread " << threadId << " :: entered LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_generate_Program(threadId)." << std::endl;
		...
		std::cout << "thread " << threadId << " :: exiting LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_generate_Program(threadId)." << std::endl;
		return CLIB_WriteEnableForThreadsAt_DataStack_stat_CLASS_get_ptr_Framework(threadId);
	}
	unsigned char* CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(uint8_t threadId)	{
		std::cout << "thread " << threadId << " :: entered LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(threadId)." << std::endl;
		bool* result = nullptr;
		...
		*result = true;
		...
		std::cout << "thread " << threadId << " :: exiting LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_get_FLAG_isPGM_INSTANTIATED(threadId)." << std::endl;
	...
	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_terminate_Program(uint8_t threadId)	{
		std::cout << "thread " << threadId << " :: entered LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_terminate_Program(threadId)." << std::endl;
		if (!CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_get_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(threadId)->at(0)) {
		...
		std::cout << "thread " << threadId << " :: exiting LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_terminate_Program(threadId)." << std::endl;
	}

	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_write_End(uint8_t threadId, unsigned char* bytes)	{
		std::cout << "thread " << threadId << " :: entered LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_write_End(threadId)." << std::endl;
		if (!CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_get_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(threadId)->at(0)) {
			CLIB_WriteEnableForThreadsAt_DataStack_stat_CLASS_get_ptr_Framework(threadId)->dyn_CLASS_get_ptr_WriteEnableForThreadsAt_DataStack_App(threadId)->dyn_APP_FUNCT_write_End(threadId, CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_CLASS_get_ptr_Framework(threadId), WriteEnableForThreadsAt_DataStack_Framework_Global::stat_APP_CONVERT_WriteEnableForThreadsAt_DataStack_MsbByteArray_To_Msbuint8_t(threadId, bytes));
		...
		std::cout << "thread " << threadId << " :: exiting LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_write_End(threadId)." << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_write_Start(uint8_t threadId, unsigned char* bytes) {
		std::cout << "thread " << threadId << " :: entered LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_write_Start(threadId)." << std::endl;
		if (!CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_get_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(threadId)->at(0)) {
		...
		std::cout << "thread " << threadId << " :: exiting LIB :: CLIBOpenEpiCentre : CLIB_WriteEnableForThreadsAt_DataStack : CLIB_WriteEnableForThreadsAt_DataStack_App_FUNCT_write_Start(threadId)." << std::endl;
	}
	bool CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_APP_FUNCT_Calc_IsAllINSTANTIATED(uint8_t threadId) {
	...
	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_CLASS_boot1_DEFINE_Framework(uint8_t threadId) {
		_stat_REG_ptr_Framework_WriteEnableForThreadsAt_DataStack = nullptr;
	}
	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_CLASS_boot3_INITIALISE_Framework(uint8_t threadId) {
		_stat_REG_ptr_Framework_WriteEnableForThreadsAt_DataStack = new class CLIBOpenEpiCentre::WriteEnableForThreadsAt_DataStack_Framework(threadId);
		while (CLIB_WriteEnableForThreadsAt_DataStack_stat_CLASS_get_ptr_Framework(threadId) == nullptr) {}
	}
	CLIBOpenEpiCentre::WriteEnableForThreadsAt_DataStack_Framework* CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_CLASS_get_ptr_Framework(uint8_t threadId)	{
		return _stat_REG_ptr_Framework_WriteEnableForThreadsAt_DataStack;
	}
	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_boot1_DEFINE_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(uint8_t threadId) {
		_stat_REG_FLAG_CLIB_WriteEnableForThreadsAt_DataStack_isMemberFunctionINSTANTIATED = nullptr;
	}
	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_boot2_SUBSTANTIATE_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(uint8_t threadId) {
	...
	void CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_boot3_INITIALISE_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(uint8_t threadId) {
		for (int index = 0; index < CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_get_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(threadId)->size(); index++) {
			CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_get_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(threadId)->at(index) = true;
		}
	}
	std::array<bool, 5>* CLIBOpenEpiCentre::CLIB_WriteEnableForThreadsAt_DataStack::CLIB_WriteEnableForThreadsAt_DataStack_stat_REG_get_CLIBLaunchQueAtDataStack_isFLAGINSTANTIATED(uint8_t threadId) {
