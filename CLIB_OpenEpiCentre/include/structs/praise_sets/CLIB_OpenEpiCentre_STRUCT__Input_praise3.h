...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        double dyn_REG_get_Item_Input_praise3_valueA();
        double dyn_REG_get_Item_Input_praise3_valueB();
        void dyn_REG_set_Item_Input_praise3_valueA(double newValue);
        void dyn_REG_set_Item_Input_praise3_valueB(double newValue);
    private:
        static double* _stat_REG_ptr_Input_praise3_valueA;
        static double* _stat_REG_ptr_Input_praise3_valueB;
        ...
        static double* stat_REG_get_Ptr_Input_praise3_valueA();
        static double* stat_REG_get_Ptr_Input_praise3_valueB();
    };
}
#endif