...
namespace CLIBOpenEpiCentre
{
    ...
    {
    public:
        void app_do_Concurrent_Algorithm_For_PraiseEventId(class CLIB_OpenEpiCentre__Framework obj, int32_t playerId, int32_t praiseEventId, class Object* ptr_Input_Subset, class Object* ptr_Output_Subset);
        ...
        static void stat_app_thread_Concurrency(CLIB_OpenEpiCentre__Framework* obj, int32_t concurrent_threadID);
