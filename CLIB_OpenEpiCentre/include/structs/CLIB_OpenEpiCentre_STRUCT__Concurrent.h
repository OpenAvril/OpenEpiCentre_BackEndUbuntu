...
namespace CLIBOpenEpiCentre
{
    ...
    {
    public:
        void app_do_Concurrent_Algorithm_For_PraiseEventId(class CLIB_OpenEpiCentre__Framework* obj, uint8_t playerId, unsigned long long praiseEventId, class Object* ptr_Input_Subset, class Object* ptr_Output_Subset);
        ...
        uint8_t dyn_REG_get_CLIB_OpenEpiCentre__Concurrent__threadId();
        void dyn_REG_set_CLIB_OpenEpiCentre__Concurrent__threadId(uint8_t praiseId);
        static void stat_app_thread_Concurrency(CLIB_OpenEpiCentre__Framework* obj, uint8_t concurrentThreadId);
    ...
    private:
        static uint8_t* _stat_REG_CLIB_OpenEpiCentre__Concurrent__threadId;
     };
}
#endif