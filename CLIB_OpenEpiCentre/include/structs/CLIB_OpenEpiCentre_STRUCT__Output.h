...
namespace CLIBOpenEpiCentre
{
    ...
    {
    public:
        void app_select_And_Set_Output_Subset(CLIB_OpenEpiCentre__Framework* obj, uint64_t praiseEventId);
        ...
        uint64_t dyn_REG_get_ptr_Output_playerId();
        uint64_t dyn_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId();
        class Object* dyn_REG_get_ptr_Item_Of_ptr_Outputs_Subset();
        void dyn_REG_set_Output_playerId(uint64_t newPraiseId);
        void dyn_REG_set_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId(uint64_t new_uint64_t);
    ...
    private:
        static uint64_t* _REG_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId;
        static uint64_t* _REG_ptr_Output_playerId;
        ...
        static void stat_REG_boot3_INITIALISE_List_Of_PraiseOutputSubset(CLIB_OpenEpiCentre__Framework* obj, uint64_t praiseId);
        static uint64_t* stat_REG_get_ptr_Output_playerId();
        static uint64_t* stat_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId();
