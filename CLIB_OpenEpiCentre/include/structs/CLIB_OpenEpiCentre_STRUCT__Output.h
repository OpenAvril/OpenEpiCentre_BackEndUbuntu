...
namespace CLIBOpenEpiCentre
{
    ...
    {
    public:
        void app_select_And_Set_Output_Subset(CLIB_OpenEpiCentre__Framework* obj, int32_t praiseEventId);
        ...
        int32_t dyn_REG_get_ptr_Output_playerId();
        int32_t dyn_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId();
        class Object* dyn_REG_get_ptr_Item_Of_ptr_Outputs_Subset();
        void dyn_REG_set_Output_playerId(int32_t newPraiseId);
        void dyn_REG_set_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId(int32_t new_int32_t);
    ...
    private:
        static int32_t* _REG_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId;
        static int32_t* _REG_ptr_Output_playerId;
        ...
        static void stat_REG_boot3_INITIALISE_List_Of_PraiseOutputSubset(CLIB_OpenEpiCentre__Framework* obj, int32_t praiseId);
        static int32_t* stat_REG_get_ptr_Output_playerId();
        static int32_t* stat_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId();
