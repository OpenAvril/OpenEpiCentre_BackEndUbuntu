...
namespace CLIBOpenEpiCentre
{
    ...
    private:
        ...
        static bool* _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput;
        static bool* _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput;
