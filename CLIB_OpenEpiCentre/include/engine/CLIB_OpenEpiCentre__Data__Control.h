...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void app_FUNCT_pop_CLIB_OpenEpiCentre__Data__Control__STACK_Of_Input(class CLIB_OpenEpiCentre__Framework* obj, uint8_t concurrentThreadId);
        ...
        void app_FUNCT_push_CLIB_OpenEpiCentre__Data__Control__STACK_Of_Output(class CLIB_OpenEpiCentre__Framework* obj, uint8_t concurrentThreadId);
