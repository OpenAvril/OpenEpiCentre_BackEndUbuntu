...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void app_FUNCT_pop_From_Stack_Of_Input(class CLIB_OpenEpiCentre__Framework* obj, __int32_t concurrentThreadID);
        ...
        void app_FUNCT_push_To_STACK_Of_Output(class CLIB_OpenEpiCentre__Framework* obj, int32_t concurrentThreadID);
