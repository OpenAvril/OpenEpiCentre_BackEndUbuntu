...
namespace CLIBOpenEpiCentre
{
    ...
    private:
        ...
        static void stat_REG_boot2_SUBSTANTIATE_Flag_isSystemInitialised(class CLIB_OpenEpiCentre_Framework* obj);
        static void stat_REG_boot2_SUBSTANTIATE_Flag_array_ThreadInitialised(class CLIB_OpenEpiCentre_Framework* obj);
        static void stat_REG_boot3_INITIALISE_Flag_isSystemInitialised(class CLIB_OpenEpiCentre_Framework* obj);
        static void stat_REG_boot3_INITIALISE_Flag_array_ThreadInitialised(class CLIB_OpenEpiCentre_Framework* obj);
