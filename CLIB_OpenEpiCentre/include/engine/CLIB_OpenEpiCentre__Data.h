...
namespace CLIBOpenEpiCentre
{
    class CLIB_OpenEpiCentre__Data
    {
     public:
        ...
        struct CLIB_OpenEpiCentre_STRUCT__Input* dyn_REG_get_ptr_Item_Of_list_Of_ptr_array_Of_buffer_Input_ReferenceForThread(uint64_t concurrentThreadID);
        struct CLIB_OpenEpiCentre_STRUCT__Output* dyn_REG_get_ptr_Item_Of_list_Of_ptr_array_Of_buffer_Output_ReferenceForThread(uint64_t concurrentThreadID);
        struct CLIB_OpenEpiCentre_STRUCT__Input* dyn_REG_get_ptr_Item_On_vector_Of_stack_Of_InputPraise(uint64_t slot);
        struct CLIB_OpenEpiCentre_STRUCT__Output* dyn_REG_get_ptr_Item_On_vector_Of_stack_Of_OutputPraise(uint64_t slot);
        ...
        void dyn_REG_set_Item_On_Array_Of_buffer_Input_ReferenceForThread(uint64_t concurrentThreadID, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        void dyn_REG_set_Item_On_Array_Of_buffer_Output_ReferenceForThread(uint64_t concurrentThreadID, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
        void dyn_REG_set_Item_On_Vector_Of_stack_Of_InputPraise(uint64_t slot, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        void dyn_REG_set_Item_On_Vector_Of_stack_Of_OutputPraise(uint64_t slot, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
    ...
    private:
        ...
        static void stat_REG_set_Item_On_Array_Of_buffer_Input_ReferenceForThread(uint64_t concurrentThreadID, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        static void stat_REG_set_Item_On_Array_Of_buffer_Output_ReferenceForThread(uint64_t concurrentThreadID, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
        ...
        static void stat_REG_set_Item_On_Vector_Of_stack_Of_InputPraise(uint64_t slot, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        static void stat_REG_set_Item_On_Vector_Of_stack_Of_OutputPraise(uint64_t slot, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
    };
};
