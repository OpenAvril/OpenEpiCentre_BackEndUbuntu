...
namespace CLIBOpenEpiCentre {
    class CLIB_OpenEpiCentre__Data {
     public:
        ...
        struct CLIB_OpenEpiCentre_STRUCT__Input* dyn_REG_get_ptr_CLIB_OpenEpiCentre__Data__Input_at_ItemSideToREAD_For_doubleBufferInput(class CLIB_OpenEpiCentre__Framework* obj);
        struct CLIB_OpenEpiCentre_STRUCT__Input* dyn_REG_get_ptr_CLIB_OpenEpiCentre__Data__Input_at_ItemSideToWRITE_For_doubleBufferInput(class CLIB_OpenEpiCentre__Framework* obj);
        struct CLIB_OpenEpiCentre_STRUCT__Output* dyn_REG_get_ptr_CLIB_OpenEpiCentre__Data__Output_at_ItemSideToREAD_For_doubleBufferOutput(class CLIB_OpenEpiCentre__Framework* obj);
        struct CLIB_OpenEpiCentre_STRUCT__Output* dyn_REG_get_ptr_CLIB_OpenEpiCentre__Data__Output_at_ItemSideToWRITE_For_doubleBufferOutput(class CLIB_OpenEpiCentre__Framework *obj);
        struct CLIB_OpenEpiCentre_STRUCT__Input* dyn_REG_get_ptr_CLIB_OpenEpiCentre__Data__Item_Of_list_Of_ptr_array_Of_buffer_Input_ReferenceForThread(uint8_t concurrentThreadId);
        struct CLIB_OpenEpiCentre_STRUCT__Output* dyn_REG_get_ptr_CLIB_OpenEpiCentre__Data__Item_Of_list_Of_ptr_array_Of_buffer_Output_ReferenceForThread(uint8_t concurrentThreadId);
        ...
        void dyn_REG_set_ptr_CLIB_OpenEpiCentre__Data__Input_at_ItemSideToREAD_For_doubleBufferInput(class CLIB_OpenEpiCentre__Framework* obj, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        void dyn_REG_set_ptr_CLIB_OpenEpiCentre__Data__Input_at_ItemSideToWRITE_For_doubleBufferInput(class CLIB_OpenEpiCentre__Framework* obj, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        void dyn_REG_set_ptr_CLIB_OpenEpiCentre__Data__Output_at_ItemSideToREAD_For_doubleBufferOutput(class CLIB_OpenEpiCentre__Framework* obj, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
        void dyn_REG_set_ptr_CLIB_OpenEpiCentre__Data__Output_at_ItemSideToWRITE_For_doubleBufferOutput(class CLIB_OpenEpiCentre__Framework* obj, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
        void dyn_REG_set_CLIB_OpenEpiCentre__Data__Item_On_Array_Of_buffer_Input_ReferenceForThread(uint8_t concurrentThreadId, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        void dyn_REG_set_CLIB_OpenEpiCentre__Data__Item_On_Array_Of_buffer_Output_ReferenceForThread(uint8_t concurrentThreadId, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
    ...
    private:
        ...
        static std::array<struct CLIB_OpenEpiCentre_STRUCT__Input*, 2>* _stat_REG_ptr_array_Of_buffer_ItemSide_For_doubleBufferInput;
        static std::array<struct CLIB_OpenEpiCentre_STRUCT__Output*, 2>* _stat_REG_ptr_array_Of_buffer_ItemSide_For_doubleBufferOutput;
        ...
        static void stat_REG_boot1_DEFINE_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferInput();
        static void stat_REG_boot1_DEFINE_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferOutput();
        ...
        static void stat_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferInput(CLIB_OpenEpiCentre__Framework* obj) ;
        static void stat_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferOutput(CLIB_OpenEpiCentre__Framework* obj) ;
        ...
        static void stat_REG_boot3_INITIALISE_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferInput(struct CLIB_OpenEpiCentre_STRUCT__Input* objInput);
        static void stat_REG_boot3_INITIALISE_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferOutput(struct CLIB_OpenEpiCentre_STRUCT__Output* objOutput);
        ...
        static std::array<struct CLIB_OpenEpiCentre_STRUCT__Input*, 2>* stat_get_REG_ptr_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferInput();
        static std::array<struct CLIB_OpenEpiCentre_STRUCT__Output*, 2>* stat_get_REG_ptr_CLIB_OpenEpiCentre__Data__array_Of_buffer_ItemSide_For_doubleBufferOutput();
        ...
        static void stat_REG_set_CLIB_OpenEpiCentre__Data__Item_On_Array_Of_buffer_Input_ReferenceForThread(uint8_t concurrentThreadId, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        static void stat_REG_set_CLIB_OpenEpiCentre__Data__Item_On_Array_Of_buffer_Output_ReferenceForThread(uint8_t concurrentThreadId, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
