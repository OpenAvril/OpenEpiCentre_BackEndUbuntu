...
namespace CLIBOpenEpiCentre {
    ...
    private:
        ...
        static void stat_REG_boot1_DEFINE_buffer_User_Input();
        static void stat_REG_boot1_DEFINE_buffer_User_Output();
        ...
        static void stat_REG_boot2_SUBSTANTIATE_buffer_User_Input(CLIB_OpenEpiCentre__Framework* obj);
        static void stat_REG_boot2_SUBSTANTIATE_buffer_User_Output(CLIB_OpenEpiCentre__Framework* obj);
        ...
        static void stat_REG_boot3_INITIALISE_buffer_User_Input(CLIB_OpenEpiCentre__Framework* obj);
        static void stat_REG_boot3_INITIALISE_buffer_User_Output(CLIB_OpenEpiCentre__Framework* obj);
        ...
        static struct CLIB_OpenEpiCentre_STRUCT__User_Input* stat_REG_get_ptr_buffer_User_Input();
        static struct CLIB_OpenEpiCentre_STRUCT__User_Output* stat_REG_get_ptr_buffer_User_Output();
        ...
        static void stat_REG_set_Item_On_Vector_Of_stack_Of_InputPraise(unsigned long long slot, struct CLIB_OpenEpiCentre_STRUCT__Input* newClass);
        static void stat_REG_set_Item_On_Vector_Of_stack_Of_OutputPraise(unsigned long long slot, struct CLIB_OpenEpiCentre_STRUCT__Output* newClass);
    };
};
