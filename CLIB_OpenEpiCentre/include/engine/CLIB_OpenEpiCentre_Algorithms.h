...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Algorithm(class CLIB_OpenEpiCentre_Framework* obj, struct Concurrent* objConcurrent);
    ...
    private:
        ...
        static void stat_REG_boot3_INITIALISE_list_Of_ptr_Concurrent(class CLIB_OpenEpiCentre_Framework* obj, struct Concurrent* objConcurrent);
