...
#include <cfloat>
#include <iostream>
	double* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::_stat_REG_ptr_Input_praise3_valueA;
	double* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::_stat_REG_ptr_Input_praise3_valueB;
// public.
	...
	double CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::dyn_REG_get_Item_Input_praise3_valueA()
	{
		return *stat_REG_get_Ptr_Input_praise3_valueA();
	}
	double CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::dyn_REG_get_Item_Input_praise3_valueB()
	{
		return *stat_REG_get_Ptr_Input_praise3_valueB();
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::dyn_REG_set_Item_Input_praise3_valueA(double newValue)
	{
		*stat_REG_get_Ptr_Input_praise3_valueA() = newValue;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::dyn_REG_set_Item_Input_praise3_valueB(double newValue)
	{
...
// private.
	...
	double* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::stat_REG_get_Ptr_Input_praise3_valueA()
	{
		return _stat_REG_ptr_Input_praise3_valueA;
	}
	double* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Input_praise3::stat_REG_get_Ptr_Input_praise3_valueB()
	{
