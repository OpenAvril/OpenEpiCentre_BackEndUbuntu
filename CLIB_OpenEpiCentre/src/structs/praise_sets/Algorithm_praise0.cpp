...
// public.
    ...
    {
        ptr_Out_SubSet->dyn_REG_set_output_praise0_Value(ptr_In_SubSet->dyn_REG_get_Item_Input_praise0_valueA() + ptr_In_SubSet->dyn_REG_get_Item_Input_praise0_valueB());
    }
// private.
