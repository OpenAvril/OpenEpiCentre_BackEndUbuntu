...
// public.
	...
	{
		std::cout << "thread "  << threadId << " :: entered dyn_REG_boot1_DEFINE_Input_praise2()" << std::endl;
		stat_REG_boot1_DEFINE_Input_praise2_valueA();
		stat_REG_boot1_DEFINE_Input_praise2_valueB();
		std::cout << "thread "  << threadId << " :: exiting dyn_REG_boot1_DEFINE_Input_praise2()" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Input_praise2::dyn_REG_boot2_SUBSTANTIATE_Input_praise2()
	{
		std::cout << "thread "  << threadId << " :: entered dyn_REG_boot2_SUBSTANTIATE_Input_praise2()" << std::endl;
		stat_REG_boot2_SUBSTANTIATE_Input_praise2_valueA();
		stat_REG_boot2_SUBSTANTIATE_Input_praise2_valueB();
		std::cout << "thread "  << threadId << " :: exiting dyn_REG_boot2_SUBSTANTIATE_Input_praise2()" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Input_praise2::dyn_REG_boot3_INITIALISE_Input_praise2()
	{
		std::cout << "thread "  << threadId << " :: entered dyn_REG_boot3_INITIALISE_Input_praise2()" << std::endl;
		stat_REG_boot3_INITIALISE_Input_praise2_valueA();
		stat_REG_boot3_INITIALISE_Input_praise2_valueB();
		std::cout << "thread "  << threadId << " :: exiting dyn_REG_boot3_INITIALISE_Input_praise2()" << std::endl;
	}
