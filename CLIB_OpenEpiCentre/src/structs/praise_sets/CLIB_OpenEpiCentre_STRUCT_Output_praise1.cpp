...
#include <cfloat>
#include <iostream>
	double* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Output_praise1::_REG_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value;
// public.
	...
	{
		return *stat_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value();
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Output_praise1::dyn_REG_set_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value(double newValue)
	{
		stat_REG_set_Item_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value(newValue);
	}
...
// private.
	...
	{
		_REG_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value = nullptr;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Output_praise1::stat_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value()
	{
		_REG_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value = new double();
		*_REG_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value = (double)(DBL_MAX);
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Output_praise1::stat_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value()
	{
		*_REG_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value = (double)(1.1);
	}
	double* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Output_praise1::stat_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value()
	{
		return _REG_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT_Output_praise1::stat_REG_set_Item_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value(double newValue)
	{
		*_REG_ptr_CLIB_OpenEpiCentre_STRUCT_Output_praise1_Value = newValue;
	}