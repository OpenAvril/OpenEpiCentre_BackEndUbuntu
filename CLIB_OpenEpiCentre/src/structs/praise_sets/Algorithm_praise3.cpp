...
// public.
    ...
    {
        ptr_Out_SubSet->dyn_REG_set_output_praise3_Value(ptr_In_SubSet->dyn_REG_get_Item_Input_praise3_valueA() / ptr_In_SubSet->dyn_REG_get_Item_Input_praise3_valueB());
    }
// private.
