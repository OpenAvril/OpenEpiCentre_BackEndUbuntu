...
#include <iostream>
#include <list>
    uint64_t* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::_REG_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId;
    uint64_t* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::_REG_ptr_Output_playerId;
...
// public.
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::app_select_And_Set_Output_Subset(CLIB_OpenEpiCentre__Framework* obj, uint64_t praiseEventId)
    {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::dyn_REG_boot3_INITIALISE_Output(CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Framework* obj)
    {
        ...
        stat_REG_boot3_INITIALISE_List_Of_PraiseOutputSubset(obj, (uint64_t)(0));
    ...
    uint64_t CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::dyn_REG_get_ptr_Output_playerId()
    {
        return *stat_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId();
    }
    uint64_t CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::dyn_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId()
    {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::dyn_REG_set_Output_playerId(uint64_t newPlayerId)
    {
        *stat_REG_get_ptr_Output_playerId() = newPlayerId;
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::dyn_REG_set_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId(uint64_t new_uint64_t)
    {
        *stat_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId() = new_uint64_t;
    }
...
// private.
    ...
    {
        _REG_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId = new uint64_t();
        *_REG_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId = static_cast<uint64_t>((UINT8_MAX));
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::stat_REG_boot2_SUBSTANTIATE_Output_playerId()
    {
        _REG_ptr_Output_playerId = new uint64_t();
        *_REG_ptr_Output_playerId = static_cast<uint64_t>((UINT8_MAX));
    }
    ...
    {
        *_REG_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId = static_cast<uint64_t>(0);
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::stat_REG_boot3_INITIALISE_Output_playerId()
    {
        *_REG_ptr_Output_playerId = static_cast<uint64_t>(0);
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::stat_REG_boot3_INITIALISE_List_Of_PraiseOutputSubset(CLIB_OpenEpiCentre__Framework* obj, uint64_t praiseId)
    {
        auto temp = stat_REG_get_ptr_Item_Of_ptr_Outputs_Subset()->begin();
        std::advance(temp, static_cast<uint64_t>(0));
        *temp = obj->dyn_STRUCT_get_User_Output()->dyn_CLASS_get_Item_On_List_Of_ptr_PraiseOutputSubsets(praiseId);
    }
    uint64_t* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::stat_REG_get_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId()
    {
        return _REG_ptr_CLIB_OpenEpiCentre_STRUCT__Output_praiseEventId;
    }
    uint64_t* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_STRUCT__Output::stat_REG_get_ptr_Output_playerId()
    {
