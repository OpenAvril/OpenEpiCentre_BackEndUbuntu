...
// public.
    ...
    unsigned long long CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::dyn_REG_get_Item_number_Of_Praise_Events() {
    ...
    bool CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::stat_CONVERT_CLIB_OpenEpiCentre_Global_MsbByteArray_To_Msbbool(const unsigned char* byteArray) {
        return (byteArray[7] & 1) != 0;
    }
   uint8_t CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::stat_CONVERT_CLIB_OpenEpiCentre_Global_MsbByteArray_To_Msbuint8_t(const unsigned char* byteArray) {
        uint8_t* temp;
        temp = new uint8_t();
        std::memcpy(&temp, byteArray, sizeof(uint8_t));
        return *temp;
    }
    double CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::stat_CONVERT_CLIB_OpenEpiCentre_Global_MsbByteArray_To_MsbDouble(const unsigned char* byteArray) {
        double* temp;
        temp = new double();
        std::memcpy(&temp, byteArray, sizeof(double));
        return *temp;
    }
    unsigned long long CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::stat_CONVERT_CLIB_OpenEpiCentre_Global_MsbByteArray_To_MsbunsignedLongLong(const unsigned char* byteArray)
    {
    ...
    unsigned char* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::stat_CONVERT_CLIB_OpenEpiCentre_Global_Msbuint8_t_To_MsbByteArray(uint8_t byte) {
        unsigned char* temp;
        temp = new unsigned char();
        std::memcpy(&temp, &byte, sizeof(uint8_t));
        return temp;
    }
    unsigned char* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::stat_CONVERT_CLIB_OpenEpiCentre_Global_MsbDouble_To_MsbByteArray(double value) {
        unsigned char* buffer = nullptr;
        buffer = new unsigned char();
...
// private.
    ...
    unsigned long long* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global::stat_REG_get_Ptr_number_Of_Praise_Events()
    {
