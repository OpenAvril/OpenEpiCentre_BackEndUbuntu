...
#include <iostream>
    ...
    bool* CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput;
    bool* CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput;
// public.
    ...
    CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::~CLIB_OpenEpiCentre__Data__Control() {
        ...
        delete _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput;
        delete _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput;
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::app_FUNCT_flip_CLIB_OpenEpiCentre__Data__Control__REG_Input_DoubleBuffer(class CLIB_OpenEpiCentre__Framework* obj) {
        obj->dyn_CLASS_get_ptr_CLIB_OpenEpiCentre__Framework__App()->dyn_CLASS_get_ptr_Data()->dyn_CLASS_get_ptr_dyn_STRUCT_get_ptr_CLIB_OpenEpiCentre__Data__Control()->app_FUNCT_flip_CLIB_OpenEpiCentre__Data__Control__REG_Input_DoubleBuffer(obj);
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::app_FUNCT_flip_CLIB_OpenEpiCentre__Data__Control__REG_Output_DoubleBuffer(class CLIB_OpenEpiCentre__Framework* obj) {
        obj->dyn_CLASS_get_ptr_CLIB_OpenEpiCentre__Framework__App()->dyn_CLASS_get_ptr_Data()->dyn_CLASS_get_ptr_dyn_STRUCT_get_ptr_CLIB_OpenEpiCentre__Data__Control()->app_FUNCT_flip_CLIB_OpenEpiCentre__Data__Control__REG_Output_DoubleBuffer(obj);
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::app_FUNCT_pop_CLIB_OpenEpiCentre__Data__Control__STACK_Of_Input(CLIB_OpenEpiCentre__Framework* obj, uint8_t concurrentThreadId) {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::app_FUNCT_push_CLIB_OpenEpiCentre__Data__Control__STACK_Of_Output(CLIB_OpenEpiCentre__Framework* obj, uint8_t concurrentThreadId) {
    ...
    bool CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::dyn_REG_get_ItemSideToREAD_For_doubleBufferOfInput() {
        return !*stat_REG_get_ptr_ItemSideToWRITE_For_doubleBufferOfInput();
    }
    bool CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::dyn_REG_get_ItemSideToWRITE_For_doubleBufferOfInput() {
        return *stat_REG_get_ptr_ItemSideToWRITE_For_doubleBufferOfInput();
    }
    bool CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::dyn_REG_get_ItemSideToREAD_For_doubleBufferOfOutput() {
        return !*stat_REG_get_ptr_ItemSideToWRITE_For_doubleBufferOfOutput();
    }
    bool CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::dyn_REG_get_ItemSideToWRITE_For_doubleBufferOfOutput() {
        return *stat_REG_get_ptr_ItemSideToWRITE_For_doubleBufferOfOutput();
    }
...
// private.
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_boot1_DEFINE_ItemSideToWRITE_For_doubleBufferOfInput() {
        std::cout << "entered stat_REG_boot1_DEFINE_side_To_Write_For_doubleBuffer_Input()" << std::endl;
        _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput = nullptr;
        std::cout << "exiting stat_REG_boot1_DEFINE_side_To_Write_For_doubleBuffer_Input()" << std::endl;
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_boot1_DEFINE_ItemSideToWRITE_For_doubleBufferOfOutput() {
        std::cout << "entered stat_REG_boot1_DEFINE_side_To_Write_For_doubleBuffer_Output()" << std::endl;
        _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput = nullptr;
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_boot2_SUBSTANTIATE_ItemSideToWRITE_For_doubleBufferOfInput() {
        std::cout << "entered stat_REG_boot2_SUBSTANTIATE_side_To_Write_For_doubleBuffer_Input()" << std::endl;
        _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput = new bool();
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_boot2_SUBSTANTIATE_ItemSideToWRITE_For_doubleBufferOfOutput() {
        std::cout << "entered stat_REG_boot2_SUBSTANTIATE_side_To_Write_For_doubleBuffer_Output()" << std::endl;
        _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput = new bool();
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_boot3_INITIALISE_ItemSideToWRITE_For_doubleBufferOfInput() {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_boot3_INITIALISE_ItemSideToWRITE_For_doubleBufferOfOutput() {
    ...
    bool* CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_get_ptr_ItemSideToWRITE_For_doubleBufferOfInput() {
        std::cout << "entered stat_REG_get_ptr_side_To_Write_For_side_To_Write_For_doubleBuffer_Input()" << std::endl;
        std::cout << "thread ? :: <= _stat_REG_ptr_side_To_Write_For_doubleBuffer_Input = " << *_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput << std::endl;
        std::cout << "exiting stat_REG_get_ptr_side_To_Write_For_side_To_Write_For_doubleBuffer_Input()" << std::endl;
        return _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput;
    }
    bool* CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_get_ptr_ItemSideToWRITE_For_doubleBufferOfOutput() {
        std::cout << "entered stat_REG_get_ptr_side_To_Write_For_side_To_Write_For_doubleBuffer_Output()" << std::endl;
        std::cout << "thread ? :: <= _stat_REG_ptr_side_To_Write_For_doubleBuffer_Output = " << *_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput << std::endl;
        std::cout << "exiting stat_REG_get_ptr_side_To_Write_For_side_To_Write_For_doubleBuffer_Output()" << std::endl;
        return _stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput;
    }
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_set_Item_ItemSideToWRITE_For_doubleBufferOfInput(bool new_Bool) {
        std::cout << "entered stat_REG_set_Item_side_To_Write_For_side_To_Write_For_doubleBuffer_Input()" << std::endl;
        *_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput = new_Bool;
        std::cout << "thread ? :: => _stat_REG_ptr_side_To_Write_For_doubleBuffer_Output = " << *_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfInput << std::endl;
        std::cout << "exiting stat_REG_set_Item_side_To_Write_For_side_To_Write_For_doubleBuffer_Input()" << std::endl;
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Data__Control::stat_REG_set_Item_ItemSideToWRITE_For_doubleBufferOfOutput(bool new_Bool) {
        std::cout << "entered stat_REG_set_Item_side_To_Write_For_side_To_Write_For_doubleBuffer_Output()" << std::endl;
        *_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput = new_Bool;
        std::cout << "thread ? :: => _stat_REG_ptr_side_To_Write_For_doubleBuffer_Output = " << *_stat_REG_ptr_CLIB_OpenEpiCentre__Data__Control__ItemSideToWRITE_For_doubleBufferOfOutput << std::endl;
