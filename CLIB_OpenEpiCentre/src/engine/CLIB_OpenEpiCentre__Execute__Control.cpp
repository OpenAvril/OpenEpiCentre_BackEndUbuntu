...
// public.
	...
	bool CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Execute__Control::dyn_REG_get_Item_On_List_Of_Flag_ThreadInitialised(int32_t threadID)
	{
...
// private.
	...
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Execute__Control::stat_REG_boot2_SUBSTANTIATE_Flag_array_ThreadInitialised(CLIBOpenEpiCentre::CLIB_OpenEpiCentre__Framework* obj)
	{
		...
		for (int32_t threadId = 0; threadId < sizeof(*stat_get_ptr_list_Of_flag_ThreadInitialised()); threadId++)
		{
			auto temp = stat_get_ptr_list_Of_flag_ThreadInitialised()->begin();
			std::advance(temp, threadId);
			*temp = true;
