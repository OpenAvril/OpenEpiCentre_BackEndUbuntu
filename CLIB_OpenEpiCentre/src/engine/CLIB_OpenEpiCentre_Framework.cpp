...
// public.
	CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::CLIB_OpenEpiCentre_Framework(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered CONSTRUCTOR of CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		stat_CLASS_boot0_DECLARE_CLIB_OpenEpiCentre_Framework(threadId);
		std::cout << "thread "  << threadId << " :: exiting CONSTRUCTOR of CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
	...
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::dyn_CLASS_create_CLIB_OpenEpiCentre_Framework_Architecture(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered LIB :: dyn_CLASS_create_CLIB_OpenEpiCentre_Framework_Architecture(threadId)." << std::endl;
	...
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::dyn_CLASS_create_CLIB_OpenEpiCentre_Framework_Global_and_Settings(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered LIB :: dyn_CLASS_create_CLIB_OpenEpiCentre_Framework_Global_and_Settings(threadId)." << std::endl;
	...
	CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::dyn_CLASS_get_ptr_CLIB_OpenEpiCentre_Framework_Global(uint8_t threadId) {
	...
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Framework(uint8_t threadId, CLIB_OpenEpiCentre_Framework* obj) {
		std::cout << "thread "  << threadId << " :: entered dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		std::cout << "thread "  << threadId << " :: exiting dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Framework(uint8_t threadId, CLIB_OpenEpiCentre_Framework* obj) {
		std::cout << "thread "  << threadId << " :: entered dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		std::cout << "thread "  << threadId << " :: exiting dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework(uint8_t threadId, CLIB_OpenEpiCentre_Framework* obj) {
		std::cout << "thread "  << threadId << " :: entered dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		std::cout << "thread "  << threadId << " :: exiting dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
	...
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot0_DECLARE_CLIB_OpenEpiCentre_Framework(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot0_DECLARE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot0_DECLARE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework" << std::endl;
		stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_App(threadId);
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_App(threadId);
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Framework(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_REG_boot0_DECLARE_CLIB_OpenEpiCentre_Framework(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_REG_boot0_DECLARE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
		std::cout << "thread "  << threadId << " :: exiting stat_REG_boot0_DECLARE_CLIB_OpenEpiCentre_Framework(threadId)" << std::endl;
	}
// private.
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_App(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_App(threadId)." <<
		std::endl;_stat_CLASS_ptr_CLIB_OpenEpiCentre_Framework_App = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_App(threadId)." << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Global(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Global(threadId)." << std::endl;
		_stat_CLASS_ptr_CLIB_OpenEpiCentre_Framework_Global = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Global(threadId)." << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_App(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_App(threadId)." << std::endl;
		...
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_App(threadId)." << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Global(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Global(threadId)." << std::endl;
		_stat_CLASS_ptr_CLIB_OpenEpiCentre_Framework_Global = new CLIB_OpenEpiCentre_Global(threadId);
		while (stat_CLASS_get_ptr_CLIB_OpenEpiCentre_Framework_Global(threadId) == nullptr) {}
		std::cout << "thread "  << threadId << " :: exiting stat_CLASS_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Global(threadId)." << std::endl;
	}
	...
	CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Global* CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_CLASS_get_ptr_CLIB_OpenEpiCentre_Framework_Global(uint8_t threadId)	{
	...
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Concurrent(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Concurrent(threadId)" << std::endl;
		_stat_STRUCT_ptr_CLIB_OpenEpiCentre_Framework_Concurrent = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Concurrent(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Input(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Input(threadId)" << std::endl;
		_stat_STRUCT_CLIB_ptr_OpenEpiCentre_Framework_Input = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Input(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Output(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Output(threadId)" << std::endl;
		_stat_STRUCT_CLIB_ptr_OpenEpiCentre_Framework_Output = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Output(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Algorithm(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Algorithm(threadId)" << std::endl;
		_stat_CLASS_ptr_CLIB_OpenEpiCentre_Framework_User_Algorithm = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Algorithm(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Input(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Input(threadId)" << std::endl;
		_stat_STRUCT_ptr_CLIB_OpenEpiCentre_Framework_User_Input = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Input(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Output(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Output(threadId)" << std::endl;
		_stat_STRUCT_ptr_CLIB_OpenEpiCentre_Framework_User_Output = nullptr;
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_User_Output(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Concurrent(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Concurrent(threadId)" << std::endl;
		...
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Concurrent(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Input(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Input(threadId)" << std::endl;
		...
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Input(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Output(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Output(threadId)" << std::endl;
		...
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Output(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Algorithm(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Algorithm(threadId)" << std::endl;
		...
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Algorithm(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Input(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Input(threadId)" << std::endl;
		...
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Input(threadId)" << std::endl;
	}
	void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework::stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Output(uint8_t threadId) {
		std::cout << "thread "  << threadId << " :: entered stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Output(threadId)" << std::endl;
		...
		std::cout << "thread "  << threadId << " :: exiting stat_STRUCT_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_User_Output(threadId)" << std::endl;
	}
