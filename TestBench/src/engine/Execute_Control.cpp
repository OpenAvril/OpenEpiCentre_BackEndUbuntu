...
// public.
	...
	void TestBench_Cpp_OpenEpiCentre::Execute_Control::dyn_REG_boot2_SUBSTANTIATE_Execute_Control(Framework* obj)
	{
	...
	void TestBench_Cpp_OpenEpiCentre::Execute_Control::dyn_REG_boot3_INITIALISE_Execute_Control(Framework* obj)
	{
...
// private.
	...
	void TestBench_Cpp_OpenEpiCentre::Execute_Control::stat_REG_boot2_SUBSTANTIATE_Flag_isSystemInitialised(TestBench_Cpp_OpenEpiCentre::Framework* obj)
	{
		_stat_REG_ptr_Flag_isSystemInitialised = new bool();
		*_stat_REG_ptr_Flag_isSystemInitialised = true;
	}
	void TestBench_Cpp_OpenEpiCentre::Execute_Control::stat_REG_boot2_SUBSTANTIATE_Flag_array_ThreadInitialised(TestBench_Cpp_OpenEpiCentre::Framework* obj)
	{
	...
	void TestBench_Cpp_OpenEpiCentre::Execute_Control::stat_REG_boot3_INITIALISE_Flag_isSystemInitialised(TestBench_Cpp_OpenEpiCentre::Framework* obj)
	{
		*_stat_REG_ptr_Flag_isSystemInitialised = true;
	}
	void TestBench_Cpp_OpenEpiCentre::Execute_Control::stat_REG_boot3_INITIALISE_Flag_array_ThreadInitialised(TestBench_Cpp_OpenEpiCentre::Framework* obj)
	{
		for (uint8_t threadId = 0; threadId < sizeof(*stat_get_ptr_list_Of_flag_ThreadInitialised()); threadId++)
		{
			auto temp = stat_get_ptr_list_Of_flag_ThreadInitialised()->begin();
