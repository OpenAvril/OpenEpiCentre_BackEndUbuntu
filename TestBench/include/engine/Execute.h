...
namespace TestBench_Cpp_OpenEpiCentre
{
    class Execute
    {
     public:
        ...
        void dyn_REG_boot2_SUBSTANTIATE_Execute(class Framework* obj);
        void dyn_REG_boot3_INITIALISE_Execute(class Framework* obj);
    ...
    private:
        ...
        static void stat_REG_boot2_SUBSTANTIATE_List_Of_Threads(class Framework* obj);
        static void stat_REG_boot3_INITIALISE_List_Of_Threads(class Framework* obj);
