#ifndef TESTBENCH_CPP_OPENEPICENTRE_Framework_TESTBENCH_H
#define TESTBENCH_CPP_OPENEPICENTRE_Framework_TESTBENCH_H
namespace TestBench_Cpp_OpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_Framework();
        void dyn_REG_boot2_SUBSTANTIATE_Framework(Framework* obj);
        void dyn_REG_boot3_INITIALISE_Framework(Framework* obj);
        void dyn_PGM_boot4_INSTANTIATE_Framework();
        static void stat_CLASS_boot0_DECLARE_Framework();
        static void stat_CLASS_boot1_DEFINE_Framework();
        static void stat_CLASS_boot3_INITIALISE_Framework();
        static void stat_CLASS_boot4_INSTANTIATE_Framework();
        static void stat_REG_boot0_DECLARE_Framework();
