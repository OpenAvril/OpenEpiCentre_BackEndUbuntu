...
namespace TestBench_Cpp_OpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot2_SUBSTANTIATE_Execute_Control(class Framework* obj);
        void dyn_REG_boot3_INITIALISE_Execute_Control(class Framework* obj);
    ...
    private:
        ...
        static void stat_REG_boot2_SUBSTANTIATE_Flag_isSystemInitialised(class Framework* obj);
        static void stat_REG_boot2_SUBSTANTIATE_Flag_array_ThreadInitialised(class Framework* obj);
        static void stat_REG_boot3_INITIALISE_Flag_isSystemInitialised(class Framework* obj);
        static void stat_REG_boot3_INITIALISE_Flag_array_ThreadInitialised(class Framework* obj);
