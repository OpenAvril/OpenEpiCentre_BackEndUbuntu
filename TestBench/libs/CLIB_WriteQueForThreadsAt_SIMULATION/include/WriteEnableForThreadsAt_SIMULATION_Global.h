#ifndef CLIB_WriteEnableForThreadsAt_SIMULATION_WriteEnableForThreadsAt_SIMULATION_Global_H
#define CLIB_WriteEnableForThreadsAt_SIMULATION_WriteEnableForThreadsAt_SIMULATION_Global_H
#include <array>
#include <cstdint>
extern "C" {
    namespace CLIBWriteQueAtSIMULATION
    {
        class WriteEnableForThreadsAt_SIMULATION_Global
        {
        public:
            WriteEnableForThreadsAt_SIMULATION_Global();
            ~WriteEnableForThreadsAt_SIMULATION_Global();
            void boot1_REG_DEFINE_WriteEnableForThreadsAt_SIMULATION_Global();
            void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_SIMULATION_Global();
            void boot3_REG_INITIALISE_WriteEnableForThreadsAt_SIMULATION_Global();
            void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_SIMULATION_Global();
            ...
            static void boot0_CLASS_DECLARE_WriteEnableForThreadsAt_SIMULATION_Global();
            static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_SIMULATION_Global();
            static void boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_SIMULATION_Global();
            static void boot0_REG_DECLARE_WriteEnableForThreadsAt_SIMULATION_Global();
