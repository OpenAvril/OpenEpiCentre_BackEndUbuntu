...
#include <iostream>
#include <ostream>
    CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__Control* CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::_stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control = NULL;
    CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::WriteEnableForThreadsAt_SIMULATION__App()
    {
        CLASS_boot0_DECLARE_WriteEnableForThreadsAt_SIMULATION__App();
        CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION__App();
        CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION__App();
    }
    CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::~WriteEnableForThreadsAt_SIMULATION__App()
    {
        delete _stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control;
    }
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::CLASS_boot0_DECLARE_WriteEnableForThreadsAt_SIMULATION__App()
    {
    ...
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION__App()
    {
        std::cout << "entered CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION" << std::endl;
        stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION__App__Control();
        std::cout << "exiting CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION" << std::endl;
    }
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION__App()
    {
        std::cout << "entered CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION()" << std::endl;
        stat_CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION__App__Control();
        std::cout << "exiting CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION()" << std::endl;
    }
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::REG_boot0_DECLARE_WriteEnableForThreadsAt_SIMULATION__App()
    {
    ...
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::REG_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION__App(WriteEnableForThreadsAt_SIMULATION__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_SIMULATION__App(WriteEnableForThreadsAt_SIMULATION__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::REG_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION__App(WriteEnableForThreadsAt_SIMULATION__Framework* obj)
    {
    ...
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_SIMULATION__App(WriteEnableForThreadsAt_SIMULATION__Framework* obj)
    {
        //if thread primed and system initialised, exit, else wait.
    }
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::dyn_APP_FUNCT_write_End(WriteEnableForThreadsAt_SIMULATION__Framework* obj, uint8_t coreId)
    {
    ...
    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::dyn_APP_FUNCT_write_Start(WriteEnableForThreadsAt_SIMULATION__Framework* obj, uint8_t coreId)
    {
    ...
    {
        return stat_CLASS_get_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control();
    }

    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SIMULATION__App__Control()
    {
        _stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control = NULL;
    }

    void CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::stat_CLASS_boot3_INITIALISE_WriteEnableForThreadsAt_SIMULATION__App__Control()
    {
        _stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control = new class CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__Control();
        while (stat_CLASS_get_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control() == NULL) {}
    }
    CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__Control* CLIBWriteQueAtSIMULATION::WriteEnableForThreadsAt_SIMULATION__App::stat_CLASS_get_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control()
    {
        return _stat_CLASS_ptr_WriteEnableForThreadsAt_SIMULATION__App__Control;
    }