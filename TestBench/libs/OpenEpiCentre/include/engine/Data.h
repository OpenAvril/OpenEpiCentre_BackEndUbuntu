...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_Data(Framework_Server* obj);
        void dyn_REG_boot3_INITIALISE_Data(Framework_Server* obj, struct Input* objInput, struct Output* objOutput);
        void dyn_REG_boot4_INSTANTIATE_Data(Framework_Server* obj);
    ...
    private:
        static Data_Control* _stat_CLASS_ptr_Data_Control;
