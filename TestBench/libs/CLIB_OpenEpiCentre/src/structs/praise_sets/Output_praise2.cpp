...
#include <cfloat>
#include <iostream>
double* CLIBOpenEpiCentre::Output_praise2::_REG_ptr_output_praise2_Value;
// public.
	void CLIBOpenEpiCentre::Output_praise2::dyn_REG_boot1_DEFINE_Output_praise2()
	{
		...
		stat_REG_boot1_DEFINE_output_praise2_Value();
	...
	void CLIBOpenEpiCentre::Output_praise2::dyn_REG_boot2_SUBSTANTIATE_Output_praise2()
	{
		...
		stat_REG_boot2_SUBSTANTIATE_output_praise2_Value();
	...
	void CLIBOpenEpiCentre::Output_praise2::dyn_REG_boot3_INITIALISE_Output_praise2()
	{
		...
		stat_REG_boot3_INITIALISE_output_praise2_Value();
	...
	double CLIBOpenEpiCentre::Output_praise2::dyn_REG_get_output_praise2_Value()
	{
		return *stat_REG_get_ptr_output_praise2_Value();
	}
	void CLIBOpenEpiCentre::Output_praise2::dyn_REG_set_output_praise2_Value(double newValue)
	{
...
// private.
	void CLIBOpenEpiCentre::Output_praise2::stat_REG_boot1_DEFINE_output_praise2_Value()
	{
		_REG_ptr_output_praise2_Value = nullptr;
	}
	void CLIBOpenEpiCentre::Output_praise2::stat_REG_boot2_SUBSTANTIATE_output_praise2_Value()
	{
		_REG_ptr_output_praise2_Value = new double();
		*_REG_ptr_output_praise2_Value = (double)(DBL_MAX);
	}
	void CLIBOpenEpiCentre::Output_praise2::stat_REG_boot3_INITIALISE_output_praise2_Value()
	{
		*_REG_ptr_output_praise2_Value = (double)(2.2);
	}
	double* CLIBOpenEpiCentre::Output_praise2::stat_REG_get_ptr_output_praise2_Value()
	{
		return _REG_ptr_output_praise2_Value;
	}
	void CLIBOpenEpiCentre::Output_praise2::stat_REG_set_Item_output_praise2_Value(double newValue)
	{
