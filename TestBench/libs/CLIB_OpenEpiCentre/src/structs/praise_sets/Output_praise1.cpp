...
#include <cfloat>
#include <iostream>
	double* CLIBOpenEpiCentre::Output_praise1::_REG_ptr_output_praise1_Value;
// public.
	void CLIBOpenEpiCentre::Output_praise1::dyn_REG_boot1_DEFINE_Output_praise1()
	{
		...
		stat_REG_boot1_DEFINE_output_praise1_Value();
	...
	void CLIBOpenEpiCentre::Output_praise1::dyn_REG_boot2_SUBSTANTIATE_Output_praise1()
	{
		...
		stat_REG_boot2_SUBSTANTIATE_output_praise1_Value();
	...
	void CLIBOpenEpiCentre::Output_praise1::dyn_REG_boot3_INITIALISE_Output_praise1()
	{
		...
		stat_REG_boot3_INITIALISE_output_praise1_Value();
	...
	double CLIBOpenEpiCentre::Output_praise1::dyn_REG_get_output_praise1_Value()
	{
		return *stat_REG_get_ptr_output_praise1_Value();
	}
	void CLIBOpenEpiCentre::Output_praise1::dyn_REG_set_output_praise1_Value(double newValue)
	{
		stat_REG_set_Item_output_praise1_Value(newValue);
	}
	void CLIBOpenEpiCentre::Output_praise1::stat_CLASS_boot0_DECLARE_Output_praise1()
	{
	...
	void CLIBOpenEpiCentre::Output_praise1::stat_REG_boot0_DECLARE_Output_praise1()
	{
...
// private.
	void CLIBOpenEpiCentre::Output_praise1::stat_REG_boot1_DEFINE_output_praise1_Value()
	{
		_REG_ptr_output_praise1_Value = nullptr;
	}
	void CLIBOpenEpiCentre::Output_praise1::stat_REG_boot2_SUBSTANTIATE_output_praise1_Value()
	{
		_REG_ptr_output_praise1_Value = new double();
		*_REG_ptr_output_praise1_Value = (double)(DBL_MAX);
	}
	void CLIBOpenEpiCentre::Output_praise1::stat_REG_boot3_INITIALISE_output_praise1_Value()
	{
		*_REG_ptr_output_praise1_Value = (double)(1.1);
	}
	double* CLIBOpenEpiCentre::Output_praise1::stat_REG_get_ptr_output_praise1_Value()
	{
		return _REG_ptr_output_praise1_Value;
	}
	void CLIBOpenEpiCentre::Output_praise1::stat_REG_set_Item_output_praise1_Value(double newValue)
	{
