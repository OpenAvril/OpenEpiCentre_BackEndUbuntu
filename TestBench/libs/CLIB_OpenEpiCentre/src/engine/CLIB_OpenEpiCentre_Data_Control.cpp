...
// public.
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Data_Control::app_FUNCT_pop_From_Stack_Of_Input(CLIB_OpenEpiCentre_Framework* obj, uint8_t concurrentThreadID)
    {
        Input* referenceForCore = obj->dyn_CLASS_get_ptr_CLIB_OpenEpiCentre_App()->dyn_CLASS_get_ptr_Data()->dyn_REG_get_ptr_Item_Of_list_Of_ptr_array_Of_buffer_Input_ReferenceForThread(concurrentThreadID);
        ...
        delete referenceForCore;
        delete ptr_inputStack;
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Data_Control::app_FUNCT_pop_From_Stack_Of_Output(CLIB_OpenEpiCentre_Framework* obj)
    {
        ...
        delete distributeBuffer;
        delete ptr_outputStack;
    }
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Data_Control::app_FUNCT_push_To_STACK_Of_Input(CLIB_OpenEpiCentre_Framework* obj)
    {
        std::vector<Input*>* ptr_InputStack = obj->dyn_CLASS_get_ptr_CLIB_OpenEpiCentre_App()->dyn_CLASS_get_ptr_Data()->dyn_REG_get_ptr_vector_Of_stack_Of_InputPraise();
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Data_Control::app_FUNCT_push_To_STACK_Of_Output(CLIB_OpenEpiCentre_Framework* obj, uint8_t concurrentThreadID)
    {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Data_Control::dyn_REG_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Data_Control(CLIB_OpenEpiCentre_Framework* obj)
    {
