...
// public.
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Algorithms::dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Algorithm(CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework* obj)
    {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Algorithms::dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Algorithm(CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework* obj)
    {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Algorithms::dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Algorithm(CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework* obj, CLIBOpenEpiCentre::Concurrent* objConcurrent)
    {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Algorithms::dyn_REG_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Algorithm(CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework* obj)
    {
...
// private.
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Algorithms::stat_REG_boot2_SUBSTANTIATE_list_Of_ptr_Concurrent(CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework* obj)
    {
    ...
    void CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Algorithms::stat_REG_boot3_INITIALISE_list_Of_ptr_Concurrent(CLIBOpenEpiCentre::CLIB_OpenEpiCentre_Framework* obj, CLIBOpenEpiCentre::Concurrent* objConcurrent)
    {
        for (uint8_t concurrentThreadId = 0; concurrentThreadId < sizeof(*stat_REG_get_ptr_list_Of_ptr_Concurrent()); concurrentThreadId++)
        {
            auto temp = stat_REG_get_ptr_list_Of_ptr_Concurrent()->begin();
