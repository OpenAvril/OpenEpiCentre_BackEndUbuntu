...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Data(Framework_Server* obj);
        void dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Data(Framework_Server* obj, struct Input* objInput, struct Output* objOutput);
        void dyn_REG_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Data(Framework_Server* obj);
        ...
        void dyn_REG_set_Item_On_Array_Of_doubleBuffer_Input_READ(Framework_Server* obj, Input* newClass);
        void dyn_REG_set_Item_On_Array_Of_doubleBuffer_Input_WRITE(Framework_Server* obj, Input* newClass);
        void dyn_REG_set_Item_On_Array_Of_doubleBuffer_Output_READ(Framework_Server* obj, Output* newClass);
        void dyn_REG_set_Item_On_Array_Of_doubleBuffer_Output_WRITE(Framework_Server* obj, Output* newClass);
    ...
    private:
        ...
        static void stat_REG_set_Item_On_Array_Of_doubleBuffer_Input_READ(Framework_Server* obj, Input* newClass);
        static void stat_REG_set_Item_On_Array_Of_doubleBuffer_Input_WRITE(Framework_Server* obj, Input* newClass);
        static void stat_REG_set_Item_On_Array_Of_doubleBuffer_Output_READ(Framework_Server* obj, Output* newClass);
        static void stat_REG_set_Item_On_Array_Of_doubleBuffer_Output_WRITE(Framework_Server* obj, Output* newClass);
