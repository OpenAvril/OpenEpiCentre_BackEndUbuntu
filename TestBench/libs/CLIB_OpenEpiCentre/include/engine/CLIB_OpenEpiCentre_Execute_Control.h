...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Execute_Control(class Framework_Server* obj);
        void dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Execute_Control(class Framework_Server* obj);
        void dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Execute_Control(class Framework_Server* obj);
        void dyn_REG_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Execute_Control(class Framework_Server* obj);
