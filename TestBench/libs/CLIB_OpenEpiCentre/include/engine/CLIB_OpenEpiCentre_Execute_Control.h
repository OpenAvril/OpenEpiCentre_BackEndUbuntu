...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Execute_Control(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Execute_Control(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Execute_Control(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Execute_Control(class CLIB_OpenEpiCentre_Framework_Server* obj);
    ...
    private:
        ...
        static void stat_REG_boot2_SUBSTANTIATE_Flag_isSystemInitialised(class CLIB_OpenEpiCentre_Framework_Server* obj);
        static void stat_REG_boot2_SUBSTANTIATE_Flag_array_ThreadInitialised(class CLIB_OpenEpiCentre_Framework_Server* obj);
        static void stat_REG_boot3_INITIALISE_Flag_isSystemInitialised(class CLIB_OpenEpiCentre_Framework_Server* obj);
        static void stat_REG_boot3_INITIALISE_Flag_array_ThreadInitialised(class CLIB_OpenEpiCentre_Framework_Server* obj);
