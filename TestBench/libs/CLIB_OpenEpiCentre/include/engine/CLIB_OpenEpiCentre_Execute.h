...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_Execute(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Execute(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Execute(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Execute(class CLIB_OpenEpiCentre_Framework_Server* obj);
    ...
    private:
        ...
        static void stat_REG_boot2_SUBSTANTIATE_List_Of_Threads(CLIB_OpenEpiCentre_Framework_Server* obj);
        static void stat_REG_boot3_INITIALISE_List_Of_Threads(CLIB_OpenEpiCentre_Framework_Server* obj);
