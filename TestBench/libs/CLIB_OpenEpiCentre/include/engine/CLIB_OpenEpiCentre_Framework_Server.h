...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Framework_Server(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Framework_Server(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Framework_Server(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_PGM_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Framework_Server(class CLIB_OpenEpiCentre_Framework_Server* obj);
