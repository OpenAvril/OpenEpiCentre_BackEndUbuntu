...
namespace CLIBOpenEpiCentre
{
    ...
    public:
        ...
        void dyn_REG_boot1_DEFINE_CLIB_OpenEpiCentre_Algorithm(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot2_SUBSTANTIATE_CLIB_OpenEpiCentre_Algorithm(class CLIB_OpenEpiCentre_Framework_Server* obj);
        void dyn_REG_boot3_INITIALISE_CLIB_OpenEpiCentre_Algorithm(class CLIB_OpenEpiCentre_Framework_Server* obj, struct Concurrent* objConcurrent);
        void dyn_REG_boot4_INSTANTIATE_CLIB_OpenEpiCentre_Algorithm(class CLIB_OpenEpiCentre_Framework_Server* obj);
    ...
    private:
        ...
        static void stat_REG_boot2_SUBSTANTIATE_list_Of_ptr_Concurrent(class CLIB_OpenEpiCentre_Framework_Server* obj);
        static void stat_REG_boot3_INITIALISE_list_Of_ptr_Concurrent(class CLIB_OpenEpiCentre_Framework_Server* obj, struct Concurrent* objConcurrent);
