...
namespace CLIBOpenEpiCentre
{
    ...
    {
    public:
        void app_select_And_Set_Input_Subset(CLIB_OpenEpiCentre_Framework* obj, uint8_t praiseEventId);
        void dyn_REG_boot1_DEFINE_Input();
        void dyn_REG_boot2_SUBSTANTIATE_Input();
        void dyn_REG_boot3_INITIALISE_Input(CLIB_OpenEpiCentre_Framework* obj);
    ...
    private:
        ...
        static void stat_REG_boot3_INITIALISE_List_Of_PraiseInputSubset(CLIB_OpenEpiCentre_Framework* obj, uint8_t praiseId);
