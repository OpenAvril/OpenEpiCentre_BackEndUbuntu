...
namespace CLIBOpenEpiCentre
{
    ...
    {
    public:
        void app_do_Concurrent_Algorithm_For_PraiseEventId(CLIB_OpenEpiCentre_Framework obj, uint8_t playerId, uint8_t praiseEventId, class Object* ptr_Input_Subset, class Object* ptr_Output_Subset);
        ...
        static void stat_app_thread_Concurrency(CLIB_OpenEpiCentre_Framework* obj, uint8_t concurrent_threadID);
