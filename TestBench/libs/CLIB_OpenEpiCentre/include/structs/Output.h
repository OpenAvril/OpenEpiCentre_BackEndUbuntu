...
namespace CLIBOpenEpiCentre
{
    ...
    {
    public:
        void app_select_And_Set_Output_Subset(Framework_Server* obj, uint8_t praiseEventId);
        void dyn_REG_boot1_DEFINE_Output();
        void dyn_REG_boot2_SUBSTANTIATE_Output();
        void dyn_REG_boot3_INITIALISE_Output(Framework_Server* obj);
    ...
    private:
        ...
        static void stat_REG_boot3_INITIALISE_List_Of_PraiseOutputSubset(Framework_Server* obj, uint8_t praiseId);
