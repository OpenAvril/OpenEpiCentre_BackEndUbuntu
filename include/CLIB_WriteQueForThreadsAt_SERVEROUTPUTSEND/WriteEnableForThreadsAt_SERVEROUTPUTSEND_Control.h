...
extern "C"
{
    namespace CLIBWriteQueAtSERVEROUTPUTSEND
    {
        ...
        public:
            ...
            ~WriteEnableForThreadsAt_SERVEROUTPUTSEND_Control();
            static void boot0_CLASS_DECLARE_WriteEnableForThreadsAt_SERVEROUTPUTSEND_Control();
            ...
            static void boot0_REG_DECLARE_WriteEnableForThreadsAt_SERVEROUTPUTSEND_Control();
...
#endif //CLIB_WriteEnableForThreadsAt_SERVEROUTPUTSEND_WRITEENABLEFORTHREADSAT_SERVEROUTPUTSEND_CONTROL_H
