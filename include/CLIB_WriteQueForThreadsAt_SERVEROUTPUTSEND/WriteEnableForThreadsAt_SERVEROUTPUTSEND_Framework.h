...
namespace OpenAvrilCLIBWriteEnableForThreadsAtSERVEROUTPUTSEND
{
    ...
    public:
        ...
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_SERVEROUTPUTSEND_Framework();
        ...
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_SERVEROUTPUTSEND_Framework();
