...
extern "C"
{
    namespace CLIBWriteQueAtSERVERINPUTRECEIVE
    {
        ...
        public:
            ...
            ~WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
            static void boot0_CLASS_DECLARE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
            static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
            static void boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
            static void boot0_REG_DECLARE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
            void boot1_REG_DEFINE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            void boot3_REG_INITIALISE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            void boot4_PGM_INSTANTIATION_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            void app_FUNCT_writeEnable_Activate(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeEnable_SortQue(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            void app_FUNCT_writeEnable_Request(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj, uint8_t coreId);
            void app_FUNCT_writeQue_Update(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            ...
            void dynamicStagger(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj, uint8_t coreId);
            void writeEnable_ShiftQueValues(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj, uint8_t coreId_A, uint8_t coreId_B);
        private:
            ...
            static void stat_REG_boot2_SUBSTANTIATE_WriteACTIVE_Count_For_ThreadId(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteIDLE_Count_For_ThreadId(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
            static void stat_REG_boot2_SUBSTANTIATE_WriteWAIT_Count_For_ThreadId(class WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Framework* obj);
...
#endif //CLIB_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_WRITEENABLEFORTHREADSAT_SERVERINPUTRECEIVE_CONTROL_H
