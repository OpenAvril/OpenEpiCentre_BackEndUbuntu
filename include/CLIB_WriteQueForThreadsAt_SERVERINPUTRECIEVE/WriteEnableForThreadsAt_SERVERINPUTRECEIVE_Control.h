...
namespace OpenAvrilCLIBWriteEnableForThreadsAtSERVERINPUTRECEIVE
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
        ...
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control();
