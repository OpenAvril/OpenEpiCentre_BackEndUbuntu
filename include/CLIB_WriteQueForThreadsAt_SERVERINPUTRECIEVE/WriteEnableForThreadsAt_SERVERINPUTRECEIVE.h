...
extern "C"
{
    namespace CLIBWriteQueAtSERVERINPUTRECEIVE
    {
        ...
        private:
            static WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Global* _stat_CLASS_ptr_Global;
            static WriteEnableForThreadsAt_SERVERINPUTRECEIVE_Control* _stat_CLASS_ptr_WriteEnable_Control;
